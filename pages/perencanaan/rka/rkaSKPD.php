...
class rkaSKPDObj  extends DaftarObj2{	
	...
	function genRowSum($ColStyle, $Mode, $Total){
		...
		$getData = sqlArray(sqlQuery("select sum(jumlah_harga) from tabel_anggaran where o1 !='0' and (rincian_perhitungan !='' or f1 !='0' ) and id_tahap='$idTahap' and tahun ='$this->tahun' and nama_modul='RKA-SKPD' and jenis_anggaran = '$this->jenisAnggaran' $kondisiSKPD $kondisiRekening"));
	...
	$getJumlahBarang = sqlArray(sqlQuery("select * from tabel_anggaran where id_anggaran = '$rkaSKPD_idplh'"));
	...
	$getPaguYangTelahTerpakai = sqlArray(sqlQuery("select sum(jumlah_harga) as paguYangTerpakai from view_rka where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'  and no_urut = '$this->nomorUrut' and id_anggaran!='$rkaSKPD_idplh' "));
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){	
		...
		case 'sesuai':{
			...
			$getrkaSKPDnya = sqlArray(sqlQuery($queryRows));
		...
		case 'koreksi':{
			...
			foreach ($getrkaSKPDnya as $key => $value) { 
			 ...
			 if($err == ""){
				 	if(sqlNumRow(sqlQuery("select * from view_rka where o1='0' and rincian_perhitungan ='' and c1='0' and k='$k' and l='$l' and m='$m' and n='$n' and o='$o' and id_tahap='$this->idTahap'  ")) > 0){
					 ...
					 if(sqlNumRow(sqlQuery("select * from view_rka where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and k = '$k' and l ='$l' and m='$m' and n='$n' and o='$o'  and o1='$o1' and f1='0' and rincian_perhitungan ='' and id_tahap='$this->idTahap' ")) > 0){
		...
		case 'editTab':{
			...
			$getAll = sqlQuery("select * from view_rka where concat(k,'.',l,'.',m,'.',n,'.',o) ='$kodeRek' and id_tahap='$this->idTahap' and rincian_perhitungan !=''   and c1='$cmbUrusan' and c='$cmbBidang' and d='$cmbSKPD' and e='$cmbUnit' and e1='$cmbSubUnit' and bk='$bk' and ck='$ck' and p='$hiddenP' and q='$q' order by o1, rincian_perhitungan");
			sqlQuery("delete from temp_rka_221 where user='$username'");
...
$fmORDER1 = $_REQUEST['fmORDER1'];
	...
	if($this->jenisForm == "KOREKSI" || $this->jenisForm == "PENYUSUNAN" || $this->jenisForm == "VALIDASI"){
		...
		$getPaguYangTerpakai =  sqlArray(sqlQuery("select sum(jumlah_harga) as paguYangTerpakai from view_rka where c1= '$selectedC1' and c='$selectedC' and d='$selectedD' and e='$selectedE' and e1='$selectedE1' and bk='$selectedBK' and ck='$selectedCK' and p='$selectedP' and q='$selectedQ' and id_tahap = '$this->idTahap'  "));
	...
	function getDaftarOpsi($Mode=1){
		...
		if(!empty($this->idTahap)){
			...
			$getAllRekeningFromRka = sqlQuery("select * from tabel_anggaran where jenis_rka !='' and jenis_rka !='RKA-SKPD' and o1 = '0' and c1 ='0' and f1='0' and k !='0' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and nama_modul ='RKA-SKPD' ");	
			while($rows = sqlArray($getAllRekeningFromRka)){
				...
				if(strlen($k) > 1){
					...
					$data = array(
					  ...
					  if(sqlNumRow(sqlQuery("select * from view_rka where k='$k' and l='$l' and m='$m' and n='$n' and o ='$o'")) == 0){
		...
		$grabAll = sqlQuery("select * from view_rka where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'");
	...
	function Laporan($xls =FALSE){
		...
		";
		$getTotal = sqlArray(sqlQuery("select sum(jumlah_harga) from tabel_anggaran where 1=1 $kondisiSKPD $kondisiFilter  and nama_modul = 'RKA-SKPD' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' "));
		...
		while($daqry = sqlArray($aqry)){
			foreach ($daqry as $key => $value) { 
				...
				$getSumJumlahHarga = sqlArray(sqlQuery("select sum(jumlah_harga) from tabel_anggaran where k='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD $kondisiFilter and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and nama_modul = 'RKA-SKPD'"));
...
if(empty($rkaSKPD->tahun)){
	...
	$getCurrenttahap = sqlArray(sqlQuery("select * from ref_tahap_anggaran where id_tahap = '$rkaSKPD->idTahap'"));
	$rkaSKPD->currentTahap = $getCurrenttahap['nama_tahap'];
	
	$namaTahap = sqlArray(sqlQuery("select * from ref_tahap_anggaran where id_tahap = '$rkaSKPD->idTahap'"));
