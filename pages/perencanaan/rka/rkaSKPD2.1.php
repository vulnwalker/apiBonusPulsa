...
class rkaSKPD21Obj  extends DaftarObj2{	
	...
	function genRowSum($ColStyle, $Mode, $Total){
		...
		$getData = sqlArray(sqlQuery("select sum(jumlah_harga) from tabel_anggaran where o1 !='0' and (rincian_perhitungan !='' or f1 !='0' ) and id_tahap='$idTahap' and tahun ='$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and jenis_rka = '2.1' and nama_modul='RKA-SKPD' $kondisiSKPD $kondisiRekening"));
		...
		$ContentTotalHal=''; $ContentTotal='';
			...
			if($this->jenisForm == "PENYUSUNAN"){
				...
				$getDataSebelumnya = sqlArray(sqlQuery("select sum(jumlah_harga) from view_rka_2_1 where o1 !='0' and (rincian_perhitungan !='' or f1 !='0' ) and no_urut='$urutSebelumnya' and tahun ='$this->tahun' and jenis_anggaran = '$this->jenisAnggaran'  $kondisiSKPD $kondisiRekening"));
	...
	$getJumlahBarang = sqlArray(sqlQuery("select * from tabel_anggaran where id_anggaran = '$rkaSKPD21_idplh'"));
	...
	$getPaguYangTelahTerpakai = sqlArray(sqlQuery("select sum(jumlah_harga) as paguYangTerpakai from view_rka_2_1 where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'  and no_urut = '$this->nomorUrut' and id_anggaran!='$rkaSKPD21_idplh' "));
	$sisaPaguIndikatif = $paguIndikatif - $getPaguYangTelahTerpakai['paguYangTerpakai'];
    
	 if(sqlNumRow(sqlQuery("select * from view_rka_2_1 where c1='0' and f1 = '0' and k = '$k' and l ='$l' and m='$m' and n='$n' and o='$o'  and id_tahap='$this->idTahap' ")) > 0){
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){	
		...
		case 'clearTemp':{
				...
				sqlQuery("delete from temp_rka_21 where user ='$username'");	
				foreach ($_REQUEST as $key => $value) { 
			 	 $$key = $value; 
				}
		...
		case 'sesuai':{
			...
			$getrkaSKPD21nya = sqlArray(sqlQuery($queryRows));
		...
		case 'koreksi':{
			...
			foreach ($getrkaSKPD21nya as $key => $value) { 
			 ...
			 $getSisaPagu = sqlArray(sqlQuery("select sum(jumlah_harga) as paguYangTerpakai  from view_rka_2_1 where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and p='$p' and q='$q' and id_tahap='$this->idTahap' and concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p,'.',q,'.',f1,'.',f2,'.',f,'.',g,'.',h,'.',i,'.',j,'.',id_jenis_pemeliharaan,'.',k,'.',l,'.',m,'.',n,'.',o) != '$filterPagu'  and o1 !='0' and rincian_perhitungan !=''"));
			 ...
			 if($err == ""){
				 	if(sqlNumRow(sqlQuery("select * from view_rka_2_1 where o1='0' and rincian_perhitungan ='' and c1='0' and k='$k' and l='$l' and m='$m' and n='$n' and o='$o' and id_tahap='$this->idTahap'  ")) > 0){
					 ...
					 if(sqlNumRow(sqlQuery("select * from view_rka_2_1 where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and k = '$k' and l ='$l' and m='$m' and n='$n' and o='$o'  and o1='$o1' and f1='0' and rincian_perhitungan ='' and id_tahap='$this->idTahap' ")) > 0){
		...
		case 'editTab':{
			...
			$getAll = sqlQuery("select * from view_rka_2_1 where concat(k,'.',l,'.',m,'.',n,'.',o) ='$kodeRek' and id_tahap='$this->idTahap' and rincian_perhitungan !=''   and c1='$cmbUrusan' and c='$cmbBidang' and d='$cmbSKPD' and e='$cmbUnit' and e1='$cmbSubUnit'  order by o1, rincian_perhitungan");
			sqlQuery("delete from temp_rka_21 where user='$username'");
			sqlQuery("delete from temp_rincian_volume_21 where user='$username'");
		    sqlQuery("delete from temp_alokasi_rka_21 where user='$username'");
			$noUrutPekerjaan = 0;
			$angkaO2 = 0;
			$lastO1 = 0;
			while($rows = sqlArray($getAll)){
				...
				$getMaxID = sqlArray(sqlQuery("select  max(id) as gblk from temp_rka_21 where user ='$username'"));
				$maxID = $getMaxID['gblk'];
				$lastO1 = $o1;
				
				$getLastO1 = sqlArray(sqlQuery("select o1 from temp_rka_21 where id='$maxID' "));
				if($getLastO1['o1'] != $lastO1){
			 	...
			 	if($o1 != '0'){
					if(sqlNumRow(sqlQuery("select * from temp_rka_21 where  o1 ='$o1' and rincian_perhitungan ='' and user ='$username'")) > 0){
			 	...
			 	$data = array( 'c1' => $c1,
					...
					sqlQuery(VulnWalkerInsert("temp_rka_21",$data)); 
				 }
				}
				$data = array(
								'c1' => $c1,
   ...
   function setPage_OtherScript(){
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
			 ...
			 if($c1 == '0'){
				...
				$Koloms[] = array('align="right"',  );
			 	...
			 	if(empty($rincian_perhitungan) && $f1 == '0' ){
					...
					$getSumPekerjaan = sqlArray(sqlQuery("select sum(jumlah_harga), sum(volume_rek), sum(jumlah) from view_rka_2_1 where k='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD and o1='$o1' and id_tahap='$this->idTahap' "));
	 ...
	 //TAHAP PENYUSUNAN
			 ...
			 if($c1 == '0'){
				...
				$Koloms[] = array('align="right"',  );
			 	...
			 	if(empty($rincian_perhitungan) && $f1 == '0' ){
					...
					$getSumPekerjaan = sqlArray(sqlQuery("select sum(jumlah_harga), sum(volume_rek), sum(jumlah) from view_rka_2_1 where k='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD and o1='$o1' and no_urut ='$nomorBefore' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' "));
					$jumlah_harga = $getSumPekerjaan['sum(jumlah_harga)'];
					$volume_rek = $getSumPekerjaan['sum(volume_rek)'];
					$jumlah = $getSumPekerjaan['sum(jumlah)'];
					$Koloms[] = array('align="left"',"<span style='margin-left:5px;'>- ".$namaPekerjaan."</span>" );
			 ...
			 if($c1 == '0'){
			 $getTotalJumalhHarga = sqlArray(sqlQuery("select sum(jumlah_harga) as total from view_rka_2_1 where k='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD and no_urut ='$nomorBefore' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'"));
			 $Koloms[] = array('align="right"', "<span style='font-weight:bold;'>".number_format($getTotalJumalhHarga['total'] ,2,',','.')."</span>" );
			 ...
			 $getAngkaKoreksi = sqlArray(sqlQuery("select * from view_rka_2_1 where c1='$c1' and c='$c' and d='$d'  and e='$e' and e1='$e1'  and k='$k' and l='$l' and m='$m' and n='$n' and o='$o' and o1='$o1' and rincian_perhitungan ='$rincian_perhitungan'  and id_tahap='$this->idTahap'"));
			 ...
			 if(empty($rincian_perhitungan)){
				...
				if($o1 !='0'){
					...
					$Koloms[] = array('align="right"',number_format($getTotalJumalhHargaKoreksi['total'] ,2,',','.'));
				 	...
				 	$getTotalJumalhHargaKoreksi = sqlArray(sqlQuery("select sum(jumlah_harga) as total from view_rka_2_1 where k='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD and id_tahap ='$this->idTahap' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'"));
	 	...
	 	if($this->jenisFormTerakhir == "KOREKSI"){
			 ...
			 $getAngkaKoreksi = sqlArray(sqlQuery("select * from view_rka_2_1 where c1='$c1' and c='$c' and d='$d'  and e='$e' and e1='$e1'  and id_jenis_pemeliharaan='$id_jenis_pemeliharaan' and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and k='$k' and l='$l' and m='$m' and n='$n' and o='$o' and o1='$o1' and rincian_perhitungan ='$rincian_perhitungan'  and no_urut = '$this->urutTerakhir' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'"));
			 $koreksiVolumeBarang = number_format($getAngkaKoreksi['volume_rek'] ,0,',','.');
			 $koreksiSatuanHarga = number_format($getAngkaKoreksi['jumlah'] ,2,',','.');
			 $koreksiJumlahHarga = number_format($getAngkaKoreksi['volume_rek']  * $getAngkaKoreksi['jumlah'] ,2,',','.');
			 if($getAngkaKoreksi['volume_rek'] > $isi['volume_rek'] ){
			 ...
			 if(empty($rincian_perhitungan)){
				...
				if($o1 !='0'){
					...
					$getTotalJumalhHargaKoreksi = sqlArray(sqlQuery("select sum(jumlah_harga) as total from view_rka_2_1 where k='$k' and l='$l' and m='$m' and n='$n' and o='$o'  $kondisiSKPD and no_urut ='$this->urutTerakhir' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'"));
					$Koloms[] = array('align="right"',"<span style='font-weight:bold;'>". number_format($getTotalJumalhHargaKoreksi['total'],2,',','.')."</span>");
				}
			 ...
			 if(empty($rincian_perhitungan)){
				 ...
				 if($o1 !='0'){
					...
					if($kurangLebihPekerjaan == 0){
				 	...
				 	$getTotalJumalhHargaKoreksi = sqlArray(sqlQuery("select sum(jumlah_harga) as total from view_rka_2_1 where k='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD and id_tahap ='$this->urutTerakhir' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'"));
			 ...
			 if($c1 == '0'){
				...
				$ilustrasi = "";
				$Koloms[] = array('align="left"',"" );
				$getSumJumlahBarang = sqlArray(sqlQuery("select sum(volume_rek) as total from view_rka_2_1 where k='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD and no_urut ='$this->urutTerakhir' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'"));
				...
				$Koloms[] = array('align="right"',  );
			 	...
			 	if(empty($rincian_perhitungan) && $f1 == '0' ){
					...
					$getSumPekerjaan = sqlArray(sqlQuery("select sum(jumlah_harga), sum(volume_rek), sum(jumlah) from view_rka_2_1 where k='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD and o1='$o1' and no_urut ='$this->urutTerakhir' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' "));
					$jumlah_harga = $getSumPekerjaan['sum(jumlah_harga)'];
					$volume_rek = $getSumPekerjaan['sum(volume_rek)'];
					$jumlah = $getSumPekerjaan['sum(jumlah)'];
					$Koloms[] = array('align="left"',"<span style='margin-left:5px;'>- ".$namaPekerjaan."</span>" );
			 ...
			 if($c1 == '0'){
			 $getTotalJumalhHarga = sqlArray(sqlQuery("select sum(jumlah_harga) as total from view_rka_2_1 where k='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD and no_urut ='$this->urutTerakhir' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'"));
			 $Koloms[] = array('align="right"', "<span style='font-weight:bold;'>".number_format($getTotalJumalhHarga['total'] ,2,',','.')."</span>" );
			 }else{
			 	$Koloms[] = array('align="right"', number_format($jumlah_harga ,2,',','.') );
			 ...
			 if($c1 == '0'){
				...
				$getSumJumlahBarang = sqlArray(sqlQuery("select sum(volume_rek) as total from view_rka_2_1 where k='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD and no_urut ='$nomorurutSebelumnya' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'"));
				...
				$Koloms[] = array('align="right"', '' );
			 	...
			 	if(empty($rincian_perhitungan) && $f1 == '0' ){
					...
					$getSumPekerjaan = sqlArray(sqlQuery("select sum(jumlah_harga), sum(volume_rek), sum(jumlah) from view_rka_2_1 where k='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD and o1='$o1' and no_urut ='$nomorurutSebelumnya' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' "));
					$jumlah_harga = $getSumPekerjaan['sum(jumlah_harga)'];
					$volume_rek = $getSumPekerjaan['sum(volume_rek)'];
					$jumlah = $getSumPekerjaan['sum(jumlah)'];
					$Koloms[] = array('align="left"',"<span style='margin-left:5px;'>- ".$namaPekerjaan."</span>" );
			 ...
			 if($c1 == '0'){
			 $getTotalJumalhHarga = sqlArray(sqlQuery("select sum(jumlah_harga) as total from view_rka_2_1 where k='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD and no_urut ='$nomorurutSebelumnya' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'"));
			 $Koloms[] = array('align="right"', "<span style='font-weight:bold;'>".number_format($getTotalJumalhHarga['total'] ,2,',','.')."</span>" );
...
$fmORDER1 = $_REQUEST['fmORDER1'];
	...
	function getDaftarOpsi($Mode=1){
		...
		if($this->jenisForm == 'PENYUSUNAN'){
			...
			$getAllParent = sqlQuery("select * from view_rka_2_1 where id_tahap='$this->idTahap'  and o1 ='0' ");
			$angka = 1;
			...
			while($rows = sqlArray($getAllParent)){
				...
				$cekRekening = sqlNumRow(sqlQuery("select * from view_rka_2_1 where id_tahap = '$this->idTahap' and k='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD and rincian_perhitungan != ''   "));
				if($cekRekening == 0){
					$concat = $k.".".$l.".".$m.".".$n.".".$o;
			...
			$nomorUrutSebelumnya = $this->nomorUrut - 1;
			$getJenisTahapSebelumnya = sqlArray(sqlQuery("select * from view_rka_2_1 where no_urut = '$nomorUrutSebelumnya'  and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and o1 !='0' and  rincian_perhitungan !=''"));
			$jenisTahapSebelumnya = $getJenisTahapSebelumnya['jenis_form_modul'];
			$getAllTahapSebelumnya = sqlQuery("select * from view_rka_2_1 where tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and no_urut ='$nomorUrutSebelumnya' and o1 !='0' and (rincian_perhitungan !='' or f1 !='0' )  ");
			while($rows = sqlArray($getAllTahapSebelumnya)){
				if( $jenisTahapSebelumnya == "VALIDASI" && $rows['status_validasi'] != '1' ){
						...
						if(sqlNumRow(sqlQuery("select * from view_rka_2_1 where c1='$cmbUrusanForm' and c='$cmbBidangForm' and d='$cmbSKPDForm' and e='$cmbUnitForm' and e1='$cmbSubUnitForm' and k = '$k' and l ='$l' and m='$m' and n='$n' and o='$o'  and o1='$o1' and f1='0' and rincian_perhitungan ='' and id_tahap='$this->idTahap' ")) > 0){
				...
				if($cekRekening == 0){
					...
					//VulnWalker
						if(!empty($hiddenP)){
							...
							$getCheckingPekerjaan =  sqlQuery("select * from view_rka_2_1 where concat(k,'.',l,'.',m,'.',n,'.',o) != '$concat' and id_tahap = '$this->idTahap' and o1 !='0' and rincian_perhitungan ='' and c1='$cmbUrusan' and c='$cmbBidang' and d='$cmbSKPD' and e='$cmbUnit' and e1='$cmbSubUnit'") ;
							while($chroot = sqlArray($getCheckingPekerjaan)){
								$chrootO1 = $chroot['o1'];
								$chrootIdAnggaran = $chroot['id_anggaran'];
								if(sqlNumRow(sqlQuery("select * from view_rka_2_1 where id_tahap ='$this->idTahap' and o1= '$chrootO1' and concat(k,'.',l,'.',m,'.',n,'.',o) != '$concat'  and rincian_perhitungan != '' $kondisiSKPD")) > 0){
			...
			$nomorUrutSebelumnya = $this->nomorUrut - 1;
			$getAllParent = sqlQuery("select * from view_rka_2_1 where no_urut='$nomorUrutSebelumnya' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'  and o1 ='0'  ");
			$angka = 1;	
			...
			while($rows = sqlArray($getAllParent)){
				...
				if($jenis_form_modul == "VALIDASI"){
					...
					$getDataValidasi = sqlQuery("select * from view_rka_2_1 where no_urut='$nomorUrutSebelumnya' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'  and o1 !='0' and (rincian_perhitungan !='' or f1 !='0')");
					while($got = sqlArray($getDataValidasi)){
						if($got['status_validasi'] !='1'){
							...
							$gotO = $got['o'];
							$gotO1 = $got['o1'];
							$getDataPekerjaanValidasi = sqlArray(sqlQuery("select * from view_rka_2_1 where c1='$gotC1' and c='$gotC' and d='$gotD' and e='$gotE' and e1='$gotE1' and k='$gotK' and l='$gotL' and m='$gotM' and n='$gotN' and o ='$gotO' and o1='$gotO1' and rincian_perhitungan ='' and f1='0' and no_urut='$nomorUrutSebelumnya' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'"));
							$idValidasiPekerjaan = $getDataPekerjaanValidasi['id_anggaran'];
							if(sqlNumRow(sqlQuery("select * from view_rka_2_1 where c1='$gotC1' and c='$gotC' and d='$gotD' and e='$gotE' and e1='$gotE1' and k='$gotK' and l='$gotL' and m='$gotM' and n='$gotN' and o ='$gotO' and o1='$gotO1'  and no_urut='$nomorUrutSebelumnya' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and status_validasi ='1' and (rincian_perhitungan !='' or f1!='0')")) == 0){
				...
				$cekRekening = sqlNumRow(sqlQuery("select * from view_rka_2_1 where no_urut='$nomorUrutSebelumnya' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and k='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD and rincian_perhitungan != '' $kondisiFilter   "));
				if($cekRekening == 0){
					$concat = $k.".".$l.".".$m.".".$n.".".$o;
					$arrKondisi[] = "concat(k,'.',l,'.',m,'.',n,'.',o) != '$concat'";
					...
					//VulnWalker
						if(!empty($hiddenP)){
							...
							$getCheckingPekerjaan =  sqlQuery("select * from view_rka_2_1 where concat(k,'.',l,'.',m,'.',n,'.',o) != '$concat' and no_urut='$nomorUrutSebelumnya' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and o1 !='0' and rincian_perhitungan ='' and c1='$cmbUrusan' and c='$cmbBidang' and d='$cmbSKPD' and e='$cmbUnit' and e1='$cmbSubUnit'") ;
							while($chroot = sqlArray($getCheckingPekerjaan)){
								$chrootO1 = $chroot['o1'];
								$chrootIdAnggaran = $chroot['id_anggaran'];
								if(sqlNumRow(sqlQuery("select * from view_rka_2_1 where no_urut='$nomorUrutSebelumnya' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and o1= '$chrootO1' and concat(k,'.',l,'.',m,'.',n,'.',o) != '$concat'  and rincian_perhitungan != '' $kondisiSKPD")) > 0){
			...
			if($this->jenisFormTerakhir == "KOREKSI"){
				...
				$getAllParent = sqlQuery("select * from view_rka_2_1 where no_urut='$this->urutTerakhir' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'  and o1 ='0'  ");
			$angka = 1;	
			...
			while($rows = sqlArray($getAllParent)){
				foreach ($rows as $key => $value) { 
			 	 $$key = $value; 
					...
					$cekRekening = sqlNumRow(sqlQuery("select * from view_rka_2_1 where no_urut='$this->urutTerakhir' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and k='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD and rincian_perhitungan != ''   "));
					if($cekRekening == 0){
						$concat = $k.".".$l.".".$m.".".$n.".".$o;
						$arrKondisi[] = "concat(k,'.',l,'.',m,'.',n,'.',o) != '$concat'";
						...
						//VulnWalker
							if(!empty($hiddenP)){
								...
								$getCheckingPekerjaan =  sqlQuery("select * from view_rka_2_1 where concat(k,'.',l,'.',m,'.',n,'.',o) != '$concat' and no_urut='$this->urutTerakhir' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and o1 !='0' and rincian_perhitungan ='' and c1='$cmbUrusan' and c='$cmbBidang' and d='$cmbSKPD' and e='$cmbUnit' and e1='$cmbSubUnit'") ;
								while($chroot = sqlArray($getCheckingPekerjaan)){
									$chrootO1 = $chroot['o1'];
									$chrootIdAnggaran = $chroot['id_anggaran'];
									if(sqlNumRow(sqlQuery("select * from view_rka_2_1 where no_urut='$this->urutTerakhir' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and o1= '$chrootO1' and concat(k,'.',l,'.',m,'.',n,'.',o) != '$concat'  and rincian_perhitungan != '' $kondisiSKPD")) > 0){
				...
				while($rows = sqlArray($getAllParent)){
					...
					$cekRekening = sqlNumRow(sqlQuery("select * from view_rka_2_1 where no_urut='$nomorUrutSebelumnya' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'  and k='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD and rincian_perhitungan != ''   "));
					if($cekRekening == 0){
						$concat = $k.".".$l.".".$m.".".$n.".".$o;
						$arrKondisi[] = "concat(k,'.',l,'.',m,'.',n,'.',o) != '$concat'";
...
function Laporan($xls =FALSE){
		...
		if($this->jenisForm == 'PENYUSUNAN'){
			...
			while($rows = sqlArray($getAllParent)){
				...
				if($jenis_form_modul == "VALIDASI"){
					$kondisiFilter = " and status_validasi = '1' ";
					$getDataValidasi = sqlQuery("select * from view_rka_2_1 where no_urut='$nomorUrutSebelumnya' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'  and o1 !='0' and (rincian_perhitungan !='' or f !='00')");
					while($got = sqlArray($getDataValidasi)){
						if($got['status_validasi'] !='1'){
							$gotID = $got['id_anggaran'];
							$arrKondisi[] = " id_anggaran !='$gotID' ";
							...
							$gotO = $got['o'];
							$gotO1 = $got['o1'];
							$getDataPekerjaanValidasi = sqlArray(sqlQuery("select * from view_rka_2_1 where c1='$gotC1' and c='$gotC' and d='$gotD' and e='$gotE' and e1='$gotE1' and k='$gotK' and l='$gotL' and m='$gotM' and n='$gotN' and o ='$gotO' and o1='$gotO1' and rincian_perhitungan ='' and f='00' and no_urut='$nomorUrutSebelumnya' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'"));
							$idValidasiPekerjaan = $getDataPekerjaanValidasi['id_anggaran'];
		...
		while($daqry = sqlArray($aqry)){
			...
			if($o1 == 0){
				...
				$getSumJumlahHarga = sqlArray(sqlQuery("select sum(jumlah_harga) from view_rka_2_1 where $Kondisi and k = '$k' and l='$l' and m='$m' and n='$n' and o='$o'  "));
				...
				$getSumJumlahHarga = sqlArray(sqlQuery("select sum(jumlah_harga) from view_rka_2_1 where $Kondisi and o1 ='$o1'  "));
...
if(empty($rkaSKPD21->tahun)){
	...
	$getCurrenttahap = sqlArray(sqlQuery("select * from ref_tahap_anggaran where id_tahap = '$rkaSKPD21->idTahap'"));
	$rkaSKPD21->currentTahap = $getCurrenttahap['nama_tahap'];
	
	$namaTahap = sqlArray(sqlQuery("select * from ref_tahap_anggaran where id_tahap = '$rkaSKPD21->idTahap'"));
