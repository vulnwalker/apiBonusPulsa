...
$fmLEVELPENGGUNA = cekPOST("fmLEVELPENGG UNA","");
...
if($Act == "Add")
{
	...
	$fmSANDIPENGGUNA = "";
	$fmLEVELPENGGUNA = "";
	if(empty($fmUrusan) || $fmUrusan == '00')$fmUrusan="0";
	$fmGROUPPENGGUNA = $fmUrusan.".".$fmSKPD.".".$fmUNIT.".".$fmSUBUNIT.".".$fmSEKSI;
	$fmMODUL01 = "0";
	$fmMODUL02 = "0";
	$fmMODUL03 = "0";
	$fmMODUL04 = "0";
...
//SKPD
$ListUrusan = cmbQuery1("fmUrusan",$fmUrusan,"select c1,nm_skpd from ref_skpd where c1!='0' and c='00' and d ='00' and e = '00' ","onChange=\"adminForm.submit()\" ",'Pilih Semua','00');
