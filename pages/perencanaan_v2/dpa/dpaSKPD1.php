...
class dpaSKPD1_v2Obj  extends DaftarObj2{	
	...
	function genRowSum($ColStyle, $Mode, $Total){
		...
		$getData = sqlArray(sqlQuery("select sum(jumlah_harga) from tabel_anggaran where  (rincian_perhitungan !='' or f !='00' ) and id_tahap='$idTahap' and tahun ='$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and jenis_rka = '1' and nama_modul='DPA-SKPD' $kondisiSKPD $kondisiRekening  and nama_modul = 'DPA-SKPD'"));
	...
	$getJumlahBarang = sqlArray(sqlQuery("select * from tabel_anggaran where id_anggaran = '$dpaSKPD1_v2_idplh'"));
	...
	$getPaguYangTelahTerpakai = sqlArray(sqlQuery("select sum(jumlah_harga) as paguYangTerpakai from view_dpa_1 where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'  and no_urut = '$this->nomorUrut' and id_anggaran!='$dpaSKPD1_v2_idplh' "));
	$sisaPaguIndikatif = $paguIndikatif - $getPaguYangTelahTerpakai['paguYangTerpakai'];
    
	 if(sqlNumRow(sqlQuery("select * from view_dpa_1 where c1='0' and f = '00' and k = '$k' and l ='$l' and m='$m' and n='$n' and o='$o'  and id_tahap='$this->idTahap' ")) > 0){
	  ...
	  switch($tipe){	
		...
		case 'Report':{	
			...
			if(empty($cmbUrusan)){
				...
				if(sqlNumRow(sqlQuery("select * from skpd_report_dpa_1 where username= '$this->username'")) == 0){
					$data = array(
		...
		case 'clearTemp':{
				...
				sqlQuery("delete from temp_dpa_1_v2 where user ='$username'");	
				foreach ($_REQUEST as $key => $value) { 
			 	 $$key = $value; 
				}
		...
		case 'checkAlokasi':{
			...
			if($this->jenisForm != "READ"){
				...
				$o = $getKodeRekening['o'];
				$jenisAlokasi = "";
				if(sqlNumRow(sqlQuery("select * from tabel_spd where tahun ='$this->tahun' and anggaran ='$this->jenisAnggaran' and c1 ='$c1' and c='$c' and d ='$d' and k='$k' and l='$l' and m='$m' and n ='$n' and o ='$o'  and jenis_rka = '1' and jenis_dpa = 'DPA-SKPD'")) != 0){
					$getAlokasi = sqlArray(sqlQuery("select * from tabel_spd where tahun ='$this->tahun' and anggaran ='$this->jenisAnggaran' and c1 ='$c1' and c='$c' and d ='$d' and k='$k' and l='$l' and m='$m' and n ='$n' and o ='$o' and jenis_rka = '1' and jenis_dpa = 'DPA-SKPD' "));
			...
			if($this->jenisForm != "READ"){
				...
				if($err == ""){
					...
					if(sqlNumRow(sqlQuery("select * from tabel_spd where tahun ='$this->tahun' and anggaran ='$this->jenisAnggaran' and c1 ='$c1' and c='$c' and d ='$d' and k='$k' and l='$l' and m='$m' and n ='$n' and o ='$o'  and jenis_rka = '1' and jenis_dpa = 'DPA-SKPD'")) == 0){
						...
						$grepId = sqlArray(sqlQuery("select * from tabel_spd where tahun ='$this->tahun' and anggaran ='$this->jenisAnggaran' and c1 ='$c1' and c='$c' and d ='$d' and k='$k' and l='$l' and m='$m' and n ='$n' and o ='$o'  and jenis_rka = '1' and jenis_dpa = 'DPA-SKPD'"));
						$id = $grepId['id'];
						$data = array(
										'jenis_alokasi_kas' => $jenisAlokasi,
										"alokasi_jan" => $jan,
		...
		if(!empty($hiddenP)){
			...
			$getIDTahap = sqlArray(sqlQuery("select * from ref_tahap_anggaran where no_urut ='$this->urutTerakhir' and tahun ='$this->tahun' and anggaran='$this->jenisAnggaran'"));			
			 ...
			 if($c1 == '0'){
				...
				$tanda = "";
			 	$getAllMemberOfThisRekening = sqlQuery("select * from view_dpa_1 where id_tahap = '$idTahap' and k='$k' and l ='$l' and m = '$m' and n ='$n' and o ='$o' and (rincian_perhitungan != '' or j!='000')");
				...
				for($nambur = 0 ; $nambur < sizeof($arrayMemberRek) ; $nambur++){
					if(sqlNumRow(sqlQuery("select * from tabel_spd where tahun = '$this->tahun' and anggaran = '$this->jenisAnggaran' and jenis_rka = '1' and jenis_dpa = 'DPA-SKPD' and concat(c1,'.',c,'.',d) = '$arrayMemberRek[$nambur]'  and k='$k' and l ='$l' and m = '$m' and n ='$n' and o ='$o'")) == 0){
						$tanda = "color:red;";
					}
				}	 
			 ...
			 //batas
			 	if(strlen($k) > 1){
					...
					if($k == '0' && $n == '0'){
						...
						$jarak = '15px';
				 		$cekAdaParent = sqlNumRow(sqlQuery("select * from view_dpa_1 where id_tahap = '$idTahap' and o1 = '$o1' and o1 !='0' and o1 !='' "));
				...
				$ilustrasi = "";
				$getSumJumlahBarang = sqlArray(sqlQuery("select sum(volume_rek) as total from view_dpa_1 where k='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD and id_tahap='$idTahap'"));
				$Koloms[] = array('align="left"',"" );
			 ...
			 $getSumSatuanRek = sqlArray(sqlQuery("select sum(jumlah) as total from view_dpa_1 where k='$k' and l='$l' and m='$m' and n='$n'  and o='$o' $kondisiSKPD and id_tahap='$idTahap'"));
			 ...
			 if($c1 == '0'){
			 if($k == '0' && $n =='0'){
			 	$getTotalJumalhHarga = sqlArray(sqlQuery("select sum(jumlah_harga) as total from view_dpa_1 where o1='$o1' $kondisiSKPD $kondisiBelanja and id_tahap='$idTahap'"));
			 }else{
			 	$getTotalJumalhHarga = sqlArray(sqlQuery("select sum(jumlah_harga) as total from view_dpa_1 where k='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD and id_tahap='$idTahap'"));	
			 }
	...
	function getDaftarOpsi($Mode=1){
	  ...
	  if(isset($cmbUrusan) && $cmbUrusan== ''){
		...
		if($this->jenisForm == 'READ'){
			...
			$getJenisFormRka = sqlArray(sqlQuery("selecrt * from view_rka_1 where id_tahap = '$idTahapTerakhir'"));
			if($getJenisFormRka['jenis_form_modul'] == "PENYUSUNAN" && $this->wajibValidasi == TRUE ){
				$kondisiFilter = $kondisiFilter." and status_validasi ='1' ";
			}
			
			$getAllChildern = sqlQuery("select * from view_rka_1 where id_tahap = '$idTahapTerakhir' and rincian_perhitungan !='' $kondisiFilter ");
			...
			while($rows = sqlArray($getAllChildern)){
				...
				if(sqlNumRow(sqlQuery("select * from view_dpa_1 where k='$k' and l='$l' and m='$m' and n='$n' and o='$o' and c1 = '0' and id_tahap='$this->idTahap' ")) == 0){
					$arrayRekening = array(
												 'c1' => '0',
												 'c' => '00',
												 'd' => '00',
				...
				if(sqlNumRow(sqlQuery("select * from view_dpa_1 where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and k='$k' and l='$l' and m='$m' and n='$n' and o='$o' and o1='$o1' and rincian_perhitungan = '$rincian_perhitungan' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and id_tahap='$this->idTahap'")) == 0){
						$data = array(	'c1' => $c1,
										'c' => $c,
										'd' => $d,
										'e' => $e,
		...
		$getMaxIdTahapDPA= sqlArray(sqlQuery("select max(id_tahap) from view_dpa_1 where tahun='$this->tahun' and jenis_anggaran = '$this->jenisAnggaran'"));
		...
		$arrKondisi[] = "c1 !='0'";
				...
				$getIDTahap = sqlArray(sqlQuery("select * from ref_tahap_anggaran where no_urut ='$this->urutTerakhir' and tahun ='$this->tahun' and anggaran='$this->jenisAnggaran'"));			
				$idTahap = $getIDTahap['id_tahap'];
				$getAllParent = sqlQuery("select * from view_dpa_1 where id_tahap ='$idTahap'  and o1 !='0' and k='0' and n='0' and rincian_perhitungan=''  ");	
				while($rows = sqlArray($getAllParent)){
					foreach ($rows as $key => $value) { 
				 	 $$key = $value; 
					}
					$cekPekerjaan = sqlNumRow(sqlQuery("select * from view_dpa_1 where o1 = '$o1' and id_tahap ='$idTahap' $kondisiRekening $kondisiSKPD and (rincian_perhitungan !='' or rincian_perhitungan!='') "));
					if($cekPekerjaan == 0){
						$arrKondisi[] = "o1 !='$o1'";
					}else{
						$arrKondisi[] = " id_tahap='$idTahap'  or id_anggaran = '$id_anggaran' ";
						$getAllRekening = sqlQuery("select * from view_dpa_1 where id_tahap = '$idTahap'  and c1 = '0' and j ='000' and rincian_perhitungan = '' and k!='0' and n !='0'  ");				
						while($row2s = sqlArray($getAllRekening)){
							foreach ($row2s as $key => $value) { 
						 	 $$key = $value; 
							}
							$cekRekening = sqlNumRow(sqlQuery("select * from view_dpa_1 where k ='$k' and l='$l' and m='$m' and n='$n' and o='$o' and id_tahap ='$idTahap' $kondisiRekening $kondisiSKPD and (rincian_perhitungan !='' or rincian_perhitungan!='') "));
							if($cekRekening == 0){
								$concat = $k.".".$l.".".$m.".".$n.".".$o;
								$arrKondisi[] = "concat(k,'.',l,'.',m,'.',n,'.',o)  !='$concat'";
							}else{
								$arrKondisi[] = " id_tahap='$idTahap'  or id_anggaran = '$id_anggaran'  ";
								$getAllProgram = sqlQuery("select * from view_dpa_1 where id_tahap = '$idTahap' and p != '0' and q ='0' and j ='000' and rincian_perhitungan = ''   ");				
								while($row3s = sqlArray($getAllProgram)){
									foreach ($row3s as $key => $value) { 
								 	 $$key = $value; 
									}
									$cekProgram = sqlNumRow(sqlQuery("select * from view_dpa_1 where bk ='$bk' and ck='$ck' and p='$p' and id_tahap ='$idTahap' $kondisiRekening $kondisiSKPD and (rincian_perhitungan !='' or rincian_perhitungan!='') "));
									if($cekProgram == 0){
										$concat = $bk.".".$ck.".".$p;
										$arrKondisi[] = "concat(bk,'.',ck,'.',p)  !='$concat'";
									}else{
										$arrKondisi[] = " id_tahap='$idTahap'  or id_anggaran = '$id_anggaran'   ";
										$getAllKegiatan = sqlQuery("select * from view_dpa_1 where id_tahap = '$idTahap' and bk ='$bk' and ck='$ck' and p='$p' and q != '0'  and j ='000' and rincian_perhitungan = ''   ");				
										while($row4s = sqlArray($getAllKegiatan)){
											foreach ($row4s as $key => $value) { 
										 	 $$key = $value; 
											}
											$cekKegiatan = sqlNumRow(sqlQuery("select * from view_dpa_1 where bk ='$bk' and ck='$ck' and p='$p' and q='$q' and id_tahap ='$idTahap' $kondisiRekening $kondisiSKPD and (rincian_perhitungan !='' or rincian_perhitungan!='') "));
											if($cekKegiatan == 0){
												$concat = $bk.".".$ck.".".$p;
												$arrKondisi[] = "concat(bk,'.',ck,'.',p)  !='$concat'";
											}else{
				...
				$grabNonMapingRekening= sqlQuery("select * from view_dpa_1 where id_tahap ='$idTahap' and (LENGTH(k) > 1) and rincian_perhitungan=''");
				while($got = sqlArray($grabNonMapingRekening)){
					if(sqlNumRow(sqlQuery("select * from view_dpa_1 where id_tahap ='$idTahap' and k ='".$got['k']."' and l ='".$got['l']."' and m ='".$got['m']."' and n ='".$got['n']."' and o ='".$got['o']."' and rincian_perhitungan!='' $kondisiRekening $kondisiSKPD ")) != 0){
						$arrKondisi[] = "id_tahap = '$idTahap' or id_anggaran ='".$got['id_anggaran']."'";
					}
					
				}
				
				$grabNonHostedRekening= sqlQuery("select * from view_dpa_1 where id_tahap ='$idTahap' and (LENGTH(k) = 1 and k !='0') and rincian_perhitungan=''");
...
function Laporan($xls =FALSE){
		...
		";
		$getTotal = sqlArray(sqlQuery("select sum(jumlah_harga) from view_dpa_1 where $Kondisi  "));
		...
		while($daqry = sqlArray($aqry)){
			...
			if($k == '0' && $n =='0' ){
				...
				$getSumJumlahHarga = sqlArray(sqlQuery("select sum(jumlah_harga) from view_dpa_1 where  o1 ='$o1' $kondisiSKPD $kondisiFilter  "));
				...
				$getSumJumlahHarga = sqlArray(sqlQuery("select sum(jumlah_harga) from view_dpa_1 where  k = '$k' and l='$l' and m='$m' and n='$n' and o='$o'  $kondisiSKPD $kondisiFilter"));
...
function formAlokasi($dt){	
	...
	$arrayJenisPerhitungan = array(
	 ...
	 if(sqlNumRow(sqlQuery("select * from tabel_spd where tahun ='$this->tahun' and anggaran ='$this->jenisAnggaran' and c1 ='$cmbUrusan' and c='$cmbBidang' and d ='$cmbSKPD' and k='$k' and l='$l' and m='$m' and n ='$n' and o ='$o'  and jenis_rka ='1' and jenis_dpa = 'DPA-SKPD'")) != 0 ){
	 	$grabSPD = sqlArray(sqlQuery("select * from tabel_spd where tahun ='$this->tahun' and anggaran ='$this->jenisAnggaran' and c1 ='$cmbUrusan' and c='$cmbBidang' and d ='$cmbSKPD' and k='$k' and l='$l' and m='$m' and n ='$n' and o ='$o' and jenis_rka ='1' and jenis_dpa = 'DPA-SKPD'"));
...
if(empty($dpaSKPD1_v2->tahun)){
	...
	$get1 = sqlArray(sqlQuery("select max(id_anggaran)  from view_dpa_1 "));
	$maxAnggaran = $get1['max(id_anggaran)'];
	$get2 = sqlArray(sqlQuery("select * from view_dpa_1 where id_anggaran = '$maxAnggaran'"));
	...
	$getCurrenttahap = sqlArray(sqlQuery("select * from ref_tahap_anggaran where id_tahap = '$dpaSKPD1_v2->idTahap'"));
	$dpaSKPD1_v2->currentTahap = $getCurrenttahap['nama_tahap'];
	
	$namaTahap = sqlArray(sqlQuery("select * from ref_tahap_anggaran where id_tahap = '$dpaSKPD1_v2->idTahap'"));
