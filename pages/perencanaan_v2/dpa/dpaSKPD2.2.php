...
class dpaSKPD22_v2Obj  extends DaftarObj2{	
	...
	function genRowSum($ColStyle, $Mode, $Total){
		...
		if(!empty($this->jenisForm)){
			...
			$getIdTahapDPATerakhir = sqlArray(sqlQuery("select max(id_tahap) as max from tabel_anggaran where tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and jenis_rka !='' and  (rincian_perhitungan !='' or f !='00' ) and nam_modul ='DPA-SKPD' "));
		...
		while($got = sqlArray($getAllKegiatan)){
			...
			$gotE1 = $got['e1'];
			$gotQ= $got['q'];
			$getIdAwalRenja = sqlArray(sqlQuery("select min(id_anggaran) as idAwalRenja from view_renja where c1='$gotC1' and c='$gotC' and d='$gotD'  and bk='$bk' and ck='$ck' and p='$p' and q='$gotQ' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'  "));
		...
		$getTotalPegawai = sqlArray(sqlQuery("select sum(jumlah_harga) from tabel_anggaran where  (rincian_perhitungan !='' or f !='00' ) and id_tahap='$idTahap' and tahun ='$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and jenis_rka = '2.2.1' and k = '5' and l ='2' and m='1' $kondisiSKPD $kondisiRekening"));
		$TotalBelanjaPegawai = $getTotalPegawai['sum(jumlah_harga)'];
		$getTotalBarangJasa = sqlArray(sqlQuery("select sum(jumlah_harga) from tabel_anggaran where  (rincian_perhitungan !='' or f !='00' ) and id_tahap='$idTahap' and tahun ='$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and jenis_rka = '2.2.1' and k = '5' and l ='2' and m='2' $kondisiSKPD $kondisiRekening"));
		$TotalBelanjaBarangJasa = $getTotalBarangJasa['sum(jumlah_harga)'];
		$getTotalModal = sqlArray(sqlQuery("select sum(jumlah_harga) from tabel_anggaran where  (rincian_perhitungan !='' or f !='00' ) and id_tahap='$idTahap' and tahun ='$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and jenis_rka = '2.2.1' and k = '5' and l ='2' and m='3' $kondisiSKPD $kondisiRekening"));
	...
	$getJumlahBarang = sqlArray(sqlQuery("select * from tabel_anggaran where id_anggaran = '$dpaSKPD22_v2_idplh'"));
	...
	$getPaguYangTelahTerpakai = sqlArray(sqlQuery("select sum(jumlah_harga) as paguYangTerpakai from view_dpa_2_2_1 where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'  and no_urut = '$this->nomorUrut' and id_anggaran!='$dpaSKPD22_v2_idplh' "));
	$sisaPaguIndikatif = $paguIndikatif - $getPaguYangTelahTerpakai['paguYangTerpakai'];
    
	 if(sqlNumRow(sqlQuery("select * from view_dpa_2_2_1 where c1='0' and f1 = '0' and k = '$k' and l ='$l' and m='$m' and n='$n' and o='$o'  and id_tahap='$this->idTahap' ")) > 0){
	  ...
	  switch($tipe){	
		case 'Report':{	
			...
			if(empty($cmbUrusan)){
				...
				if(sqlNumRow(sqlQuery("select * from skpd_report_dpa_2_2 where username= '$this->username'")) == 0){
					$data = array(
   ...
   function setPage_OtherScript(){
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 foreach ($_REQUEST as $key => $value) { 
		...
		if(!empty($this->idTahap)){
				...
				if($this->jenisForm == "PENYUSUNAN" && $this->wajibValidasi == TRUE){
				 ...
				 $getIdTahapTerakhir = sqlArray(sqlQuery("select max(id_tahap) from tabel_anggaran where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and nama_modul = 'DPA-SKPD'"));
	 ...
	 if($q == '0'){
	 	$getNamaProgram = sqlArray(sqlQuery("select * from ref_program where bk='".$isi['bk']."' and ck='".$isi['ck']."' and dk='0' and p='$p' and q='0'"));
		...
		$getAllKegiatan = sqlQuery("select * from view_dpa_2_2 where bk='".$isi['bk']."' and ck='".$isi['ck']."' and p='$p' and q!='0' $kondisiSKPD ");
		while($got = sqlArray($getAllKegiatan)){
			$gotC1= $got['c1'];
			$gotC= $got['c'];
			$gotD= $got['d'];
		...
		$tahunPlus = number_format($sumTahunPlus ,2,',','.');
	 	...
	 	$getNamaKegiatan = sqlArray(sqlQuery("select * from ref_program where bk='".$isi['bk']."' and ck='".$isi['ck']."' and dk='0' and p='$p' and q='$q'"));
		$namaKegiatan =  $getNamaKegiatan['nama'];
	 	$Koloms[] = array('align="left"', "<span style='margin-left:10px;'>".$namaKegiatan."</span>" );
		$getIdAwalRenja = sqlArray(sqlQuery("select min(id_anggaran) as idAwalRenja from view_renja where c1='$c1' and c='$c' and d='$d'  and bk='".$isi['bk']."' and ck='".$isi['ck']."' and p='$p' and q='$q' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'  "));
		$idAwalRenja = $getIdAwalRenja['idAwalRenja'];
		$getDetailRenja = sqlArray(sqlQuery("select * from detail_renja where id_anggaran ='$idAwalRenja'"));
		
		$Koloms[] = array('align="left"', $getDetailRenja['lokasi_kegiatan'] );
		$Koloms[] = array('align="left"', $getDetailRenja['capaian_program_tk'] );
		$getDetailRenja = sqlArray(sqlQuery("select * from view_renja where id_anggaran ='$idAwalRenja'"));
		$Koloms[] = array('align="left"',  $getDetailRenja['sumber_dana'] );
		$tahunPlus = number_format($getDetailRenja['plus'] ,2,',','.');
	 }
	 if($q != '0'){
	 	 $getBelanjaPegawai = sqlArray(sqlQuery("select sum(jumlah_harga) as belanjaPegawai from tabel_anggaran where nama_modul = 'DPA-SKPD' $kondisiSKPD $kondisiFilter and bk='".$isi['bk']."' and ck='".$isi['ck']."' and p='$p' and q='$q' and k='5' and l='2' and m='1' "));
	   	 $getBelanjaBarangJasa = sqlArray(sqlQuery("select sum(jumlah_harga) as belanjaBarangJasa from tabel_anggaran where nama_modul = 'DPA-SKPD' $kondisiSKPD $kondisiFilter and bk='".$isi['bk']."' and ck='".$isi['ck']."' and p='$p' and q='$q' and k='5' and l='2' and m='2' "));
	 	 $getBelanjaModal = sqlArray(sqlQuery("select sum(jumlah_harga) as belanjaModal from tabel_anggaran where nama_modul = 'DPA-SKPD' $kondisiSKPD $kondisiFilter and bk='".$isi['bk']."' and ck='".$isi['ck']."' and p='$p' and q='$q' and k='5' and l='2' and m='3' "));
		 ...
		 $Koloms[] = array('align="right"', $tahunPlus );
	 	 ...
	 	 $getBelanjaPegawai = sqlArray(sqlQuery("select sum(jumlah_harga) as belanjaPegawai from tabel_anggaran where nama_modul = 'DPA-SKPD' $kondisiSKPD $kondisiFilter and bk='".$isi['bk']."' and ck='".$isi['ck']."' and p='$p'  and k='5' and l='2' and m='1' "));
	   	 $getBelanjaBarangJasa = sqlArray(sqlQuery("select sum(jumlah_harga) as belanjaBarangJasa from tabel_anggaran where nama_modul = 'DPA-SKPD' $kondisiSKPD $kondisiFilter and bk='".$isi['bk']."' and ck='".$isi['ck']."' and p='$p'  and k='5' and l='2' and m='2' "));
	 	 $getBelanjaModal = sqlArray(sqlQuery("select sum(jumlah_harga) as belanjaModal from tabel_anggaran where nama_modul = 'DPA-SKPD' $kondisiSKPD $kondisiFilter and bk='".$isi['bk']."' and ck='".$isi['ck']."' and p='$p'  and k='5' and l='2' and m='3' "));
...
$fmORDER1 = $_REQUEST['fmORDER1'];
	...
	if($this->jenisForm == "KOREKSI" || $this->jenisForm == "PENYUSUNAN" || $this->jenisForm == "VALIDASI"){
		...
		$getPaguYangTerpakai =  sqlArray(sqlQuery("select sum(jumlah_harga) as paguYangTerpakai from view_dpa_2_2_1 where c1= '$selectedC1' and c='$selectedC' and d='$selectedD' and e='$selectedE' and e1='$selectedE1' and bk='$selectedBK' and ck='$selectedCK' and p='$selectedP' and q='$selectedQ' and id_tahap = '$this->idTahap'  "));
		...
		$getPaguYangTerpakai =  sqlArray(sqlQuery("select sum(jumlah_harga) as paguYangTerpakai from view_dpa_2_2_1 where c1= '$selectedC1' and c='$selectedC' and d='$selectedD' and e='$selectedE' and e1='$selectedE1' and bk='$selectedBK' and ck='$selectedCK' and p='$selectedP' and q='$selectedQ' and no_urut = '$this->urutTerakhir' and tahun ='$this->tahun' and jenis_anggaran = '$this->jenisAnggaran'  "));
		$sisaPagu = $getPaguIndikatif['jumlah'] - $getPaguYangTerpakai['paguYangTerpakai'];
		$sisaPagu =  number_format($sisaPagu ,2,',','.');
		$paguIndikatif = "<input type='text' value='$angkaPaguIndikatif' readonly> &nbsp &nbsp &nbsp SISA PAGU  :  <input type='text' value='$sisaPagu' readonly>";
	...
	function getDaftarOpsi($Mode=1){
		...
		if($this->jenisForm == "READ"){
				$getAllFromRka221 = sqlQuery("select * from view_rka_2_2_1 where 1=1 $kondisiFilter   and (rincian_perhitungan !='' or f !='00')");
		    	while($rows = sqlArray($getAllFromRka221)){
				foreach ($rows as $key => $value) { 
				  $$key = $value; 
				}	
				
				if(sqlArray(sqlQuery("select * from view_dpa_2_2 where bk='$bk' and ck='$ck' and p='$p' and q='0' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' ")) > 0){
				}else{
					$data = array(
									'c1' => '0',
									'c' => '00',
				...
				if(sqlArray(sqlQuery("select * from view_dpa_2_2 where c1='$c1' and c='$c' and d='$d'  and bk='$bk' and ck='$ck' and p='$p' and q='$q' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' ")) > 0){
				}else{
					$data = array(
									'c1' => $c1,
									'c' => $c,
		...
		$getAllProgram = sqlQuery("select * from view_dpa_2_2 where q != '0'");
		$arrayProgram = array();
		while($rows = sqlArray($getAllProgram)){
			foreach ($rows as $key => $value) { 
				  $$key = $value; 
			}
			if(sqlNumRow(sqlQuery("select * from view_dpa_2_2_1 where   (rincian_perhitungan !='' or f !='00' ) and bk='$bk' and ck='$ck' and p='$p' and q='$q'   $kondisiSKPD")) == 0){
				$arrKondisi[] = "id_anggaran !='$id_anggaran'";	
				if(sqlNumRow(sqlQuery("select * from view_dpa_2_2_1 where   (rincian_perhitungan !='' or f !='00' ) and bk='$bk' and ck='$ck' and p='$p'    $kondisiSKPD")) == 0){
					$concat = $bk.".".$ck.".".$p;
					$arrKondisi[] = "concat(bk,'.',ck,'.',p) !='$concat'";
				}
			}else{
					$getIDProgram =  sqlArray(sqlQuery("select * from view_dpa_2_2 where bk='$bk' and ck='$ck' and p='$p' and  q = '0'"));
...
function Laporan($xls =FALSE){
		...
		$grabSKPD = sqlArray(sqlQuery("select * from skpd_report_dpa_2_2 where username='$this->username'"));
	 ...
	 if($q == '0'){
		...
		$getAllKegiatan = sqlQuery("select * from view_dpa_2_2 where bk='$bk' and ck='$ck' and p='$p' and q!='0' $kondisiSKPD ");
		while($got = sqlArray($getAllKegiatan)){
			$gotC1= $got['c1'];
			$gotC= $got['c'];
			$gotD= $got['d'];
		...
		$getIdAwalRenja = sqlArray(sqlQuery("select min(id_anggaran) as idAwalRenja from view_renja where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'  "));
		$idAwalRenja = $getIdAwalRenja['idAwalRenja'];
		$getDetailRenja = sqlArray(sqlQuery("select * from detail_renja where id_anggaran ='$idAwalRenja'"));
	 ...
	 if($q != '0'){
	 	 $getBelanjaPegawai = sqlArray(sqlQuery("select sum(jumlah_harga) as belanjaPegawai from tabel_anggaran where nama_modul = 'DPA-SKPD' $kondisiSKPD $kondisiFilter and bk='$bk' and ck='$ck' and p='$p' and q='$q' and k='5' and l='2' and m='1' "));
	   	 $getBelanjaBarangJasa = sqlArray(sqlQuery("select sum(jumlah_harga) as belanjaBarangJasa from tabel_anggaran where nama_modul = 'DPA-SKPD' $kondisiSKPD $kondisiFilter and bk='$bk' and ck='$ck' and p='$p' and q='$q' and k='5' and l='2' and m='2' "));
	 	 $getBelanjaModal = sqlArray(sqlQuery("select sum(jumlah_harga) as belanjaModal from tabel_anggaran where nama_modul = 'DPA-SKPD' $kondisiSKPD $kondisiFilter and bk='$bk' and ck='$ck' and p='$p' and q='$q' and k='5' and l='2' and m='3' "));
		 ...
		 echo "<td align='right' class='GarisCetak' >".number_format($tahunPlus ,2,',','.')."</td>";
	 	 ...
	 	 $getBelanjaPegawai = sqlArray(sqlQuery("select sum(jumlah_harga) as belanjaPegawai from tabel_anggaran where nama_modul = 'DPA-SKPD' $kondisiSKPD $kondisiFilter and bk='$bk' and ck='$ck' and p='$p'  and k='5' and l='2' and m='1' "));
	   	 $getBelanjaBarangJasa = sqlArray(sqlQuery("select sum(jumlah_harga) as belanjaBarangJasa from tabel_anggaran where nama_modul = 'DPA-SKPD' $kondisiSKPD $kondisiFilter and bk='$bk' and ck='$ck' and p='$p'  and k='5' and l='2' and m='2' "));
	 	 $getBelanjaModal = sqlArray(sqlQuery("select sum(jumlah_harga) as belanjaModal from tabel_anggaran where nama_modul = 'DPA-SKPD' $kondisiSKPD $kondisiFilter and bk='$bk' and ck='$ck' and p='$p'  and k='5' and l='2' and m='3' "));
		echo "<td align='right' class='GarisCetak' >".number_format($getBelanjaPegawai['belanjaPegawai'] ,2,',','.')."</td>";
		 echo "<td align='right' class='GarisCetak' >".number_format($getBelanjaBarangJasa['belanjaBarangJasa'] ,2,',','.')."</td>";
		 echo "<td align='right' class='GarisCetak' >".number_format($getBelanjaModal['belanjaModal'] ,2,',','.')."</td>";
		 $jumlahRekening = $getBelanjaPegawai['belanjaPegawai'] + $getBelanjaBarangJasa['belanjaBarangJasa'] + $getBelanjaModal['belanjaModal'];
	 ...
	 echo "</tr>";
		...
		if(!empty($this->jenisForm)){
			...
			$getIdTahapDPATerakhir = sqlArray(sqlQuery("select max(id_tahap) as max from tabel_anggaran where tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and jenis_rka !='' and  (rincian_perhitungan !='' or f !='00' ) "));
		 	$idTahap = $getIdTahapDPATerakhir['max'];
		}
...
if(empty($dpaSKPD22_v2->tahun)){
	...
	$getCurrenttahap = sqlArray(sqlQuery("select * from ref_tahap_anggaran where id_tahap = '$dpaSKPD22_v2->idTahap'"));
	$dpaSKPD22_v2->currentTahap = $getCurrenttahap['nama_tahap'];
	
	$namaTahap = sqlArray(sqlQuery("select * from ref_tahap_anggaran where id_tahap = '$dpaSKPD22_v2->idTahap'"));
