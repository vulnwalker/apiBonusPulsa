...
class rkbmdPengadaan_v3Obj  extends DaftarObj2{	
	...
	<A href=\"pages.php?Pg=rkbmdPengadaan_v3\" title='RKBMD PENGADAAN MURNI' style='color : blue;' > RKBMD PENGADAAN </a> |
	<A href=\"pages.php?Pg=rkbmdPemeliharaan_v3\" title='RKBMD PEMELIHARAAN MURNI' > RKBMD PEMELIHARAAN </a> |
	...
	case 'formBaru':{				
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  sqlNumRow(sqlQuery("select * from view_renja_v3 where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaan_v3SkpdfmUrusan' and c = '$rkbmdPengadaan_v3SkpdfmSKPD' and d='$rkbmdPengadaan_v3SkpdfmUNIT' and e = '$rkbmdPengadaan_v3SkpdfmSUBUNIT' and e1='$rkbmdPengadaan_v3SkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));		
			 $getDatarenja = sqlArray(sqlQuery("select * from view_renja_v3 where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaan_v3SkpdfmUrusan' and c = '$rkbmdPengadaan_v3SkpdfmSKPD' and d='$rkbmdPengadaan_v3SkpdfmUNIT' and e = '$rkbmdPengadaan_v3SkpdfmSUBUNIT' and e1='$rkbmdPengadaan_v3SkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));	 
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = sqlNumRow(sqlQuery("select * from view_renja_v3 where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaan_v3SkpdfmUrusan' and c = '$rkbmdPengadaan_v3SkpdfmSKPD' and d='$rkbmdPengadaan_v3SkpdfmUNIT' and e = '$rkbmdPengadaan_v3SkpdfmSUBUNIT' and e1='$rkbmdPengadaan_v3SkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}
					
					$getParentrkbmdPengadaan_v3 = sqlArray(sqlQuery("select * from view_renja_v3 where id_anggaran = '$lastID'"));
		...
		case 'editTab':{
			...
			foreach ($_REQUEST as $key => $value) { 
				  $$key = $value; 
					...
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentrkbmdPengadaan_v3 = sqlArray(sqlQuery("select * from view_rkbmd_v3 where id_anggaran = '$id[0]'"));
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) { 
			 ...
			 $getSKPD = sqlArray(sqlQuery("select * from tabel_anggaran_v3 where id_anggaran = '$rkbmdPengadaan_v3_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran_v3",$data," id_anggaran = '$rkbmdPengadaan_v3_idplh'");
			 sqlQuery($query);
	   ...
	   case 'remove':{				
		...
		case 'koreksi':{
			...
			$getrkbmdPengadaan_v3nya = sqlArray(sqlQuery($queryRows));
...
$arrayResult = tahapPerencanaanV3($rkbmdPengadaan_v3->modul);
