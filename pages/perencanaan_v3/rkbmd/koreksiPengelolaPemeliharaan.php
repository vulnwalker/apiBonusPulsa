...
class koreksiPengelolaPemeliharaanObj  extends DaftarObj2{	
	...
	<A href=\"pages.php?Pg=koreksiPengelolaPengadaan\" title='RKBMD PENGADAAN MURNI'  > RKBMD PENGADAAN </a> |
	<A href=\"pages.php?Pg=koreksiPengelolaPemeliharaan\" title='RKBMD PEMELIHARAAN MURNI'  style='color : blue;'> RKBMD PEMELIHARAAN </a> |
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  sqlNumRow(sqlQuery("select * from view_renja_v3 where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPemeliharaanSkpdfmUrusan' and c = '$koreksiPengelolaPemeliharaanSkpdfmSKPD' and d='$koreksiPengelolaPemeliharaanSkpdfmUNIT' and e = '$koreksiPengelolaPemeliharaanSkpdfmSUBUNIT' and e1='$koreksiPengelolaPemeliharaanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));		
			 $getDatarenja = sqlArray(sqlQuery("select * from view_renja_v3 where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPemeliharaanSkpdfmUrusan' and c = '$koreksiPengelolaPemeliharaanSkpdfmSKPD' and d='$koreksiPengelolaPemeliharaanSkpdfmUNIT' and e = '$koreksiPengelolaPemeliharaanSkpdfmSUBUNIT' and e1='$koreksiPengelolaPemeliharaanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));	 
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' && $this->wajibValidasi == TRUE ){
						$getJumlahRenjaValidasi = sqlNumRow(sqlQuery("select * from view_renja_v3 where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPemeliharaanSkpdfmUrusan' and c = '$koreksiPengelolaPemeliharaanSkpdfmSKPD' and d='$koreksiPengelolaPemeliharaanSkpdfmUNIT' and e = '$koreksiPengelolaPemeliharaanSkpdfmSUBUNIT' and e1='$koreksiPengelolaPemeliharaanSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}
					
					$getParentkoreksiPengelolaPemeliharaan = sqlArray(sqlQuery("select * from view_renja_v3 where id_anggaran = '$lastID'"));
		...
		case 'editTab':{
			...
			foreach ($_REQUEST as $key => $value) { 
				  $$key = $value; 
					...
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentkoreksiPengelolaPemeliharaan = sqlArray(sqlQuery("select * from view_rkbmd_v3 where id_anggaran = '$id[0]'"));
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) { 
			 ...
			 $getSKPD = sqlArray(sqlQuery("select * from tabel_anggaran_v3 where id_anggaran = '$koreksiPengelolaPemeliharaan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran_v3",$data," id_anggaran = '$koreksiPengelolaPemeliharaan_idplh'");
			 sqlQuery($query);
	   ...
	   case 'remove':{				
		...
		case 'koreksi':{
			...
			$getkoreksiPengelolaPemeliharaannya = sqlArray(sqlQuery($queryRows));
...
$arrayResult = tahapKoreksi("KOREKSI PENGELOLA");
