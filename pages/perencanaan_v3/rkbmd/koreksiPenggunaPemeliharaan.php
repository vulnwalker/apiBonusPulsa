...
class koreksiPenggunaPemeliharaanObj  extends DaftarObj2{	
	...
	<A href=\"pages.php?Pg=koreksiPenggunaPengadaan\" title='RKBMD PENGADAAN MURNI'  > RKBMD PENGADAAN </a> |
	<A href=\"pages.php?Pg=koreksiPenggunaPemeliharaan\" title='RKBMD PEMELIHARAAN MURNI'  style='color : blue;'> RKBMD PEMELIHARAAN </a> |
	 ...
	 $j  = $arrayKodeBarang[4];
			...
			if($fmST == 0){ 
				...
				if($err==''){ 
						...
						$input =  sqlQuery(VulnWalkerInsert("ref_std_kebutuhan_v3",$data));
						if($input){
						...
						sqlQuery(VulnWalkerUpdate("ref_std_kebutuhan_v3",$data,"concat(c1,' ',c,' ',d,' ',e,' ',e1,' ',f,' ',g,' ',h,' ',i,' ',j) = '$idplh'"));				
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
		...
		case 'Laporan':{
			foreach ($_REQUEST as $key => $value) { 
			 ...
			 /*if($koreksiPenggunaPemeliharaanSkpdfmUrusan =='0'){
			 	...
			 	$err = "Pilih SKPD";
			 }elseif($koreksiPenggunaPemeliharaanSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($koreksiPenggunaPemeliharaanSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{*/
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  sqlNumRow(sqlQuery("select * from view_renja_v3 where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPenggunaPemeliharaanSkpdfmUrusan' and c = '$koreksiPenggunaPemeliharaanSkpdfmSKPD' and d='$koreksiPenggunaPemeliharaanSkpdfmUNIT' and e = '$koreksiPenggunaPemeliharaanSkpdfmSUBUNIT' and e1='$koreksiPenggunaPemeliharaanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));		
			 $getDatarenja = sqlArray(sqlQuery("select * from view_renja_v3 where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPenggunaPemeliharaanSkpdfmUrusan' and c = '$koreksiPenggunaPemeliharaanSkpdfmSKPD' and d='$koreksiPenggunaPemeliharaanSkpdfmUNIT' and e = '$koreksiPenggunaPemeliharaanSkpdfmSUBUNIT' and e1='$koreksiPenggunaPemeliharaanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));	 
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' && $this->wajibValidasi == TRUE ){
						$getJumlahRenjaValidasi = sqlNumRow(sqlQuery("select * from view_renja_v3 where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPenggunaPemeliharaanSkpdfmUrusan' and c = '$koreksiPenggunaPemeliharaanSkpdfmSKPD' and d='$koreksiPenggunaPemeliharaanSkpdfmUNIT' and e = '$koreksiPenggunaPemeliharaanSkpdfmSUBUNIT' and e1='$koreksiPenggunaPemeliharaanSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}
					
					$getParentkoreksiPenggunaPemeliharaan = sqlArray(sqlQuery("select * from view_renja_v3 where id_anggaran = '$lastID'"));
					...
					$getIdRenja = sqlArray(sqlQuery("select * from view_renja_v3 where tahun = '$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1 = '$parentC1' and c = '$parentC' and d = '$parentD' and e = '$parentE' and e1 = '$parentE1' and p = '0' and q = '0' and no_urut = '$nomorUrutSebelumnya' "));
					$idrenja = $getIdRenja['id_anggaran'];	
					
					$kemana = 'pemeliharaan_v3';
					$username = $_COOKIE['coID'];
					sqlQuery("delete from temp_rkbmd_pemeliharaan_v3 where user = '$username'");
					sqlQuery("delete from temp_rkbmd_pemeliharaan_v3 where user = '$username'");
					sqlQuery("delete from rkbmd_pemeliharaan_v3 where user = '$username'");
				}else{
		...
		case 'editTab':{
			...
			foreach ($_REQUEST as $key => $value) { 
				  $$key = $value; 
					...
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentkoreksiPenggunaPemeliharaan = sqlArray(sqlQuery("select * from view_rkbmd_v3 where id_anggaran = '$id[0]'"));
					...
					$parentE = $getParentkoreksiPenggunaPemeliharaan['e'];
					$parentE1= $getParentkoreksiPenggunaPemeliharaan['e1'];
					$getIdRenja = sqlArray(sqlQuery("select * from view_renja_v3 where tahun = '$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1 = '$parentC1' and c = '$parentC' and d = '$parentD' and e = '$parentD' and e1 = '$parentE1' and p = '0' and q = '0' and no_urut = '$nomorUrutSebelumnya' "));
					$idrenja = $getIdRenja['id_anggaran'];	
					
					$kemana = 'pemeliharaan_v3';
					
					$username = $_COOKIE['coID'];
					sqlQuery("delete from temp_rkbmd_pengadaan_v3 where user = '$username'");
					sqlQuery("delete from temp_rkbmd_pemeliharaan_v3 where user = '$username'");
					sqlQuery("delete from rkbmd_pemeliharaan_v3 where user = '$username'");
					
					$execute = sqlQuery("select * from view_rkbmd_v3 where  c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and tahun='$this->tahun' and id_tahap ='$this->idTahap' and f !='00' ");
							...
							sqlQuery(VulnWalkerInsert('rkbmd_pemeliharaan_v3',$data));
							}
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) { 
			 ...
			 $getSKPD = sqlArray(sqlQuery("select * from tabel_anggaran_v3 where id_anggaran = '$koreksiPenggunaPemeliharaan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran_v3",$data," id_anggaran = '$koreksiPenggunaPemeliharaan_idplh'");
			 sqlQuery($query);
	   ...
	   case 'remove':{				
			...
			for($i = 0 ; $i < sizeof($id) ; $i++ ){
				$getData = sqlArray(sqlQuery("select * from view_rkbmd_v3 where id_anggaran='$id[$i]'"));
				$c1 = $getData['c1'];
				$c = $getData['c'];
				$d = $getData['d'];
				$e = $getData['e'];
				...
				$get = sqlQuery("select * from tabel_anggaran_v3 where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and tahun='$this->tahun' and id_tahap ='$this->idTahap' and ((id_jenis_pemeliharaan != '0' and f !='00') or uraian_pemeliharaan = 'RKBMD PEMELIHARAAN') and id_anggaran!='$id[$i]' ");
				while($rows= sqlArray($get)){
					...
					if($status_validasi == '1'){
						...
						if($j !='000'){
							sqlQuery("delete from tabel_anggaran_v3 where id_anggaran ='$id_anggaran' ");
						}
					}
				}
		...
		case 'koreksi':{
			...
			$getkoreksiPenggunaPemeliharaannya = sqlArray(sqlQuery($queryRows));
			...
			if($this->jenisForm !='KOREKSI PENGGUNA' && $this->jenisForm !='KOREKSI PENGELOLA'){
				...
				$cekSKPD = sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk = '0' and ck = '0' and p = '0' and q= '0' and id_tahap='$this->idTahap'"));
				if($cekSKPD < 1){
					$data = array('jenis_anggaran' => $this->jenisAnggaran,
						...
						sqlQuery(VulnWalkerInsert('tabel_anggaran_v3',$data));
				}
				$cekProgram = sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk = '$bk' and ck = '$ck' and p = '$p' and q= '0' and id_tahap='$this->idTahap'"));												
				if($cekProgram < 1){
					$data = array('jenis_anggaran' => $this->jenisAnggaran,
								  'tahun' => $this->tahun,
								  'c1' => $c1,
				...
				$cekKegiatanPemeliharaan = sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk = '$bk' and ck = '$ck' and p = '$p' and q= '$q' and  f='00' and id_tahap='$this->idTahap' and uraian_pemeliharaan = 'RKBMD PEMELIHARAAN'"));												
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  $concat = $kodeSKPD.".".$kodeBarang;
				  ...
				  $getKebutuhanMax = sqlArray(sqlQuery("select * from ref_std_kebutuhan_v3 where concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',f,'.',g,'.',h,'.',i,'.',j) = '$concat'"));
				  $kebutuhanMax = $getKebutuhanMax['jumlah'];
				  $getKebutuhanOptimal = sqlArray(sqlQuery("select sum(jml_barang) as kebutuhanOptimal from buku_induk_v3 where concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',f,'.',g,'.',h,'.',i,'.',j) = '$concat' "));
			  ...
			  $cekKoreksi =  sqlNumRow(sqlQuery("select * from tabel_anggaran_v3 where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p = '$p' and q='$q'  and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
			  if($cekKoreksi > 0 ){
			   	 $getID = sqlArray(sqlQuery("select * from tabel_anggaran_v3 where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p = '$p' and q='$q'  and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if($getID['status_validasi'] == '1'){
							...
							sqlQuery("update tabel_anggaran_v3 set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getkoreksiPenggunaPemeliharaannya['volume_barang'] < $angkaKoreksi){
						...
						if( $getkoreksiPenggunaPemeliharaannya['volume_barang'] >= $angkaKoreksi )  {
							...
							sqlQuery(VulnWalkerUpdate("tabel_anggaran_v3",$dugDung, " id_anggaran = '$idAwal'" ));
						}elseif($getkoreksiPenggunaPemeliharaannya['volume_barang'] < $angkaKoreksi){
							$err = "Jumlah Koreksi Tidak Melebihi Pengajuan";
						}
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
		if($this->jenisForm == "PENYUSUNAN"){
			...
			$nomorUrutSebelumnya = $this->nomorUrut - 1;
			$getJenisFormSebelumnya = sqlArray(sqlQuery("select * from ref_tahap_anggaran_v3 where no_urut = '$nomorUrutSebelumnya' and tahun ='$this->tahun' and anggaran = '$this->jenisAnggaran'"));
	 ...
	 foreach ($isi as $key => $value) { 
	   ...
	   if($this->jenisForm=="PENYUSUNAN"){
				...
				if($f == '00' && $q =='0')$TampilCheckBox = "";
					...
					if($this->wajibValidasi == TRUE)$Koloms.= "<td class='$cssclass' align='left'></td>";
					 ...
					 $concat = $kodeSKPD.".".$kodeBarang;
					 $getKebutuhanOptimal = sqlArray(sqlQuery("select sum(jml_barang) as kebutuhanOptimal from buku_induk_v3 where concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',f,'.',g,'.',h,'.',i,'.',j) = '$concat' and status_barang = '1' and kondisi ='1' "));
					 $baik = $getKebutuhanOptimal['kebutuhanOptimal'];
					 $getKurangBaik = sqlArray(sqlQuery("select sum(jml_barang) as kebutuhanOptimal from buku_induk_v3 where concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',f,'.',g,'.',h,'.',i,'.',j) = '$concat' and status_barang = '1' and kondisi ='2' "));
					 $kurangBaik = $getKurangBaik['kebutuhanOptimal'];
					 $getRusakBerat = sqlArray(sqlQuery("select sum(jml_barang) as kebutuhanOptimal from buku_induk_v3 where concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',f,'.',g,'.',h,'.',i,'.',j) = '$concat' and status_barang = '1' and kondisi ='3' "));
					 $rusakBerat = $getRusakBerat['kebutuhanOptimal'];
					 $satuan = $getBarang['satuan_barang'];
					 $customConcat = $kodeSKPD.".".$bk.".".$ck.".".$p.".".$q.".".$kodeBarang;
					 $getMinID = sqlArray(sqlQuery("select min(urut) as min from view_rkbmd_v3 where concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p,'.',q,'.',f,'.',g,'.',h,'.',i,'.',j) ='$customConcat' and id_jenis_pemeliharaan != '0'"));
					 $getSumVolumeBarang = sqlArray(sqlQuery("select sum(volume_barang) as jumlah from view_rkbmd_v3 where concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p,'.',q,'.',f,'.',g,'.',h,'.',i,'.',j) ='$customConcat' and id_jenis_pemeliharaan != '0'"));
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
				if($f == '00' && $q =='0')$TampilCheckBox = "";
					...
					$Koloms.= "<td class='$cssclass' align='left'></td>";
					 ...
					 $nomorUrutSebelumnya = $this->nomorUrut -1 ;
					 $getMinID = sqlArray(sqlQuery("select min(urut) as min from view_rkbmd_v3 where concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p,'.',q,'.',f,'.',g,'.',h,'.',i,'.',j) ='$customConcat' and id_jenis_pemeliharaan != '0'"));
					 $getSumVolumeBarang = sqlArray(sqlQuery("select sum(volume_barang) as jumlah from view_rkbmd_v3 where concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p,'.',q,'.',f,'.',g,'.',h,'.',i,'.',j) ='$customConcat' and id_jenis_pemeliharaan != '0' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut = '$nomorUrutSebelumnya'"));
					 $sumVolume = $getSumVolumeBarang['jumlah'];
					 $Koloms.= "<td class='$cssclass' align='center'>$no</td>";
					 $Koloms.= $tampilHeader;
					 if($urut == $getMinID['min']){
					 ...
					 $getDataKoreksi = sqlArray(sqlQuery("select * from view_rkbmd_v3 where id_tahap='$this->idTahap' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' "));
					 $kondisiWarna = "red";
						 
						 if(sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where id_tahap='$this->idTahap' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' "))  > 0){
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGELOLA"){
					...
					$Koloms.= "<td class='$cssclass' align='left'></td>";
					 ...
					 $getMinID = sqlArray(sqlQuery("select min(urut) as min from view_rkbmd_v3 where concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p,'.',q,'.',f,'.',g,'.',h,'.',i,'.',j) ='$customConcat' and id_jenis_pemeliharaan != '0'"));
					 $getSumVolumeBarang = sqlArray(sqlQuery("select sum(volume_barang) as jumlah from view_rkbmd_v3 where concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p,'.',q,'.',f,'.',g,'.',h,'.',i,'.',j) ='$customConcat' and id_jenis_pemeliharaan != '0' and tahun = '$this->tahun' and jenis_anggaran='$this->jenisAnggaran' and no_urut = '$nomorurutkurang2'"));
					 $sumVolume = $getSumVolumeBarang['jumlah'];
					 $Koloms.= "<td class='$cssclass' align='center'>$no</td>";
					 $Koloms.= $tampilHeader;
					 if($urut == $getMinID['min']){
					 ...
					 $getJumlahBarangPertama = sqlArray(sqlQuery("select * from view_rkbmd_v3 where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan = '$id_jenis_pemeliharaan' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut = '$nomorurutkurang2'"));
			...
			elseif($this->jenisFormTerakhir == "KOREKSI PENGGUNA"){
				if($f == '00' && $q =='0')$TampilCheckBox = "";
					...
					$Koloms.= "<td class='$cssclass' align='left'></td>";
					 ...
					 $getMinID = sqlArray(sqlQuery("select min(urut) as min from view_rkbmd_v3 where concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p,'.',q,'.',f,'.',g,'.',h,'.',i,'.',j) ='$customConcat' and id_jenis_pemeliharaan != '0'"));
					 $getSumVolumeBarang = sqlArray(sqlQuery("select sum(volume_barang) as  jumlah  , catatan from view_rkbmd_v3 where concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p,'.',q,'.',f,'.',g,'.',h,'.',i,'.',j) ='$customConcat' and id_jenis_pemeliharaan != '0' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut = '$nomorUrut2TahapSebelumnya'"));
					 $sumVolume = $getSumVolumeBarang['jumlah'];
			...
			elseif($this->jenisFormTerakhir == "KOREKSI PENGELOLA"){
					...
					$Koloms.= "<td class='$cssclass' align='left'></td>";
					 ...
					 $getSumVolumeBarang = sqlArray(sqlQuery("select sum(volume_barang) as jumlah from view_rkbmd_v3 where concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p,'.',q,'.',f,'.',g,'.',h,'.',i,'.',j) ='$customConcat' and id_jenis_pemeliharaan != '0' and tahun = '$this->tahun' and jenis_anggaran='$this->jenisAnggaran' and no_urut = '$nomorUrut3TahapSebelumnya'"));
					 $sumVolume = $getSumVolumeBarang['jumlah'];
					 $Koloms.= "<td class='$cssclass' align='center'>$no</td>";
					 $Koloms.= $tampilHeader;
					 if($urut == $getMinID['min']){
					 ...
					 $Koloms.= "<td class='$cssclass' align='right'>".number_format($jumlahBarangPertama,0,',','.')."</td>";
					 $nomorUrut2TahapSebelumnya = $this->urutTerakhir -1;
					 $getDataTahapPengguna = sqlArray(sqlQuery("select * from view_rkbmd_v3 where no_urut = '$nomorUrut2TahapSebelumnya' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan = '$id_jenis_pemeliharaan' "));
	...
	function getDaftarOpsi($Mode=1){
		...
		if($this->jenisForm == "PENYUSUNAN"){
			...
			$getAllParent = sqlQuery("select * from view_rkbmd_v3 where id_tahap='$this->idTahap' and f='00' and q = '0' and e1 !='000' ");
			while($rows = sqlArray($getAllParent)){
				foreach ($rows as $key => $value) { 
			 	 $$key = $value; 
				}
				$cekSKPD = sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where id_tahap ='$this->idTahap' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1'  and f !='00' and id_jenis_pemeliharaan !='0' "));
				if($cekSKPD == 0){
					$concat = $c1.".".$c.".".$d.".".$e.".".$e1;
					$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1) != '$concat'";
				}else{
					$concat = $c1.".".$c.".".$d.".".$e.".".$e1;
					$getAllProgram = sqlQuery("select * from view_rkbmd_v3 where id_tahap='$this->idTahap' and f ='00'  and concat(c1,'.',c,'.',d,'.',e,'.',e1) = '$concat'  and p !='0' and q ='0'");
					while($rows = sqlArray($getAllProgram)){
						foreach ($rows as $key => $value) { 
					 	 $$key = $value; 
						}
						$cekProgram = sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where id_tahap ='$this->idTahap' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1'  and bk='$bk' and ck= '$ck' and p='$p' and f !='00' and id_jenis_pemeliharaan !='0' "));
						if($cekProgram == 0){
			...
			$nomorUrutSebelumnya = $this->nomorUrut -1;
			$getJenisTahapSebelumnya = sqlArray(sqlQuery("select * from view_rkbmd_v3 where no_urut = '$nomorUrutSebelumnya'  and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran'"));
			$jenisTahapSebelumnya = $getJenisTahapSebelumnya['jenis_form_modul'];
			$getAll = sqlQuery("select * from view_rkbmd_v3 where f != '00' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and no_urut = '$nomorUrutSebelumnya'");
			$arrayID = array();
			while($rows = sqlArray($getAll)){
				...
				if( $jenisTahapSebelumnya == "PENYUSUNAN" && $status_validasi != '1' && $this->wajibValidasi == TRUE ){
						...
						$resultKegiatan = sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where $Condition  f !='00' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk = '$bk' and ck='$ck' and p='$p' and q='$q' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut = '$nomorUrutSebelumnya' "));
						if($resultKegiatan  == 0){
						    $concat =  $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.'.'.$ck.'.'.$p.'.'.$q;
							$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p,'.',q) != '$concat' ";	
							$resultProgram = sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where $Condition  f !='00' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk = '$bk' and ck='$ck' and p='$p'  and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut = '$nomorUrutSebelumnya' "));
							if($resultProgram == 0){
								$concat =  $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.'.'.$ck.'.'.$p;
								$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p) != '$concat' ";	
								$resultSKPD = sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where $Condition  f !='00' and c1='$c1' and c='$c' and d='$d' and e='$e' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut = '$nomorUrutSebelumnya' "));
								if($resultSKPD == 0){
									$concat =  $c1.".".$c.".".$d.".".$e.".".$e1;
									$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1) != '$concat' ";	
								}
			...
			$getAllParent = sqlQuery("select * from view_rkbmd_v3 where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$nomorUrutSebelumnya' and f='00' and q !='0' ");
				while($rows = sqlArray($getAllParent)){
					foreach ($rows as $key => $value) { 
				 	 $$key = $value; 
					}
					$cekKegiatan = sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$nomorUrutSebelumnya' and c1='$c1' and c='$c'  and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q'  and f != '00' and id_jenis_pemeliharaan !='0'  "));
					if($cekKegiatan == 0){
						$concat = $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.".".$ck.".".$p.".".$q;
						$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p,'.',q) != '$concat'";
						$cekProgram = sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$nomorUrutSebelumnya' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and f !='00' and id_jenis_pemeliharaan !='0' "));
						if($cekProgram == 0){
							$concat = $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.".".$ck.".".$p;
							$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p) != '$concat'";
							$cekSKPD = sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$nomorUrutSebelumnya' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1'  and f !='00' and id_jenis_pemeliharaan !='0' "));
							if($cekSKPD == 0){
								$concat = $c1.".".$c.".".$d.".".$e.".".$e1;
								$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1) != '$concat'";
							}
			...
			if($this->jenisFormTerakhir =="PENYUSUNAN"){
				    $getAllParent = sqlQuery("select * from view_rkbmd_v3 where no_urut = '$this->urutTerakhir' and tahun='$this->tahun' and jenis_anggaran='$this->jenisAnggaran' and f='00' and q = '0' and e1 !='000' ");
					while($rows = sqlArray($getAllParent)){
						foreach ($rows as $key => $value) { 
					 	 $$key = $value; 
						}
						$cekSKPD = sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where no_urut = '$this->urutTerakhir' and tahun='$this->tahun' and jenis_anggaran='$this->jenisAnggaran' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1'  and f !='00' and id_jenis_pemeliharaan !='0' "));
						if($cekSKPD == 0){
							$concat = $c1.".".$c.".".$d.".".$e.".".$e1;
							$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1) != '$concat'";
						}else{
							$concat = $c1.".".$c.".".$d.".".$e.".".$e1;
							$getAllProgram = sqlQuery("select * from view_rkbmd_v3 where no_urut = '$this->urutTerakhir' and tahun='$this->tahun' and jenis_anggaran='$this->jenisAnggaran' and f ='00'  and concat(c1,'.',c,'.',d,'.',e,'.',e1) = '$concat'  and p !='0' and q ='0'");
							while($rows = sqlArray($getAllProgram)){
								foreach ($rows as $key => $value) { 
							 	 $$key = $value; 
								}
								$cekProgram = sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where no_urut = '$this->urutTerakhir' and tahun='$this->tahun' and jenis_anggaran='$this->jenisAnggaran' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1'  and bk='$bk' and ck= '$ck' and p='$p' and f !='00' and id_jenis_pemeliharaan !='0' "));
								if($cekProgram == 0){
									$concat = $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.".".$ck.".".$p;
									$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p) != '$concat'";
								}
				...
				$getAllParent = sqlQuery("select * from view_rkbmd_v3 where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$this->urutTerakhir' and f='00' and q !='0' ");
				while($rows = sqlArray($getAllParent)){
					foreach ($rows as $key => $value) { 
				 	 $$key = $value; 
					}
					$cekKegiatan = sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$this->urutTerakhir' and c1='$c1' and c='$c'  and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q'  and f != '00' and id_jenis_pemeliharaan !='0'  "));
					if($cekKegiatan == 0){
						$concat = $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.".".$ck.".".$p.".".$q;
						$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p,'.',q) != '$concat'";
						$cekProgram = sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$this->urutTerakhir' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and f !='00' and id_jenis_pemeliharaan !='0' "));
						if($cekProgram == 0){
							$concat = $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.".".$ck.".".$p;
							$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p) != '$concat'";
							$cekSKPD = sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$this->urutTerakhir' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1'  and f !='00' and id_jenis_pemeliharaan !='0' "));
							if($cekSKPD == 0){
								$concat = $c1.".".$c.".".$d.".".$e.".".$e1;
								$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1) != '$concat'";
							}
...
function Pemeliharaan1($xls =FALSE){
		...
		$getLastTahap = sqlArray(sqlQuery("select * from view_rkbmd_v3 where id_anggaran ='$lastIdAnggaran'"));
		$lastNomorUrut = $getLastTahap['no_urut'];	
		$getMinJenisForm = sqlArray(sqlQuery("select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and tahun='$this->tahun' and jenis_anggaran='$this->jenisAnggaran'"));
		...
		$grabProgram = sqlQuery("select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PEMELIHARAAN' )  and p !='0' and q='0' $jenisSKPD");
		while($rows = sqlArray($grabProgram)){
			foreach ($rows as $key => $value) { 
				  $$key = $value; 
			}
			if(sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and uraian_pemeliharaan !=''  and bk='$bk' and ck='$ck' and p ='$p' and j!='000'  $jenisSKPD")) == 0){
				$concat = $bk.".".$ck.".".$p;
				$arrKondisi[] = " concat(bk,'.',ck,'.',p) !='$concat'";
			}else{
			$grabKegiatan = sqlQuery("select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan !='RKBMD PENGADAAN' and bk='$bk' and ck='$ck'  and p ='$p' and q!='0' and j='000'");
				while($row2s = sqlArray($grabKegiatan)){
					foreach ($row2s as $key => $value) { 
						  $$key = $value; 
					}
					if(sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan !=''  and bk='$bk' and ck='$ck' and p ='$p' and q='$q' and j!='000' $jenisSKPD ")) == 0){
						if($q != '0'){
							$concat = $bk.".".$ck.".".$p.".".$q;
							$arrKondisi[] = " concat(bk,'.',ck,'.',p,'.',q) !='$concat'";
						}
					}else{
						$grabBarang = sqlQuery("select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan !='RKBMD PENGADAAN' and bk='$bk' and ck='$ck'  and p ='$p' and q='$q' and j!='000'");
						while($row3s = sqlArray($grabBarang)){
							foreach ($row3s as $key => $value) { 
								  $$key = $value; 
							}
							$concat = $f.".".$g.".".$h.".".$i.".".$j;
							if(sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and uraian_pemeliharaan !=''  and bk='$bk' and ck='$ck' and p ='$p' and q='$q' and concat(f,'.',g,'.',h,'.',i,'.',j) = '$concat' $jenisSKPD ")) == 0){
								if($j != '000'){
		...
		$qry ="select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and  uraian_pemeliharaan !='RKBMD PENGADAAN'  and urut !='$c1.$c.$d.$e.$e1.0.0.0.0.0.0.00.00.00.00.000.00' $Kondisi order by urut";
		...
		while($daqry = sqlArray($aqry)){
			...
			if($q == '0' && $j =='000'){
				...
				$programKegiatan = "";
				$kodeBarang = $f.".".$g.".".$h.".".$i.".".$j;
				$getNamaBarang = sqlArray(sqlQuery("select * from ref_barang_v3 where concat(f,'.',g,'.',h,'.',i,'.',j) = '$kodeBarang'"));
				$namaBarang = $getNamaBarang['nm_barang'];
				$volBar = number_format($volume_barang,0,'.',',');
				$getNamaPemeliharaan = sqlArray(sqlQuery("select * from ref_jenis_pemeliharaan where Id = '$id_jenis_pemeliharaan'"));
				$namaPemeliharaan = $getNamaPemeliharaan['jenis'];
				$getJumlahB = sqlArray(sqlQuery("select * from buku_induk_v3 where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and f='$f' and g='$g' and h='$h' and i='$i' and j ='$j'  and status_barang ='1' and kondisi='1'"));
				$b =  number_format($getJumlahB['jml_barang'],0,'.',',');
				$getJumlahKB = sqlArray(sqlQuery("select * from buku_induk_v3 where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and f='$f' and g='$g' and h='$h' and i='$i' and j ='$j'  and status_barang ='1' and kondisi='2'"));
				$kb =  number_format($getJumlahKB['jml_barang'],0,'.',',');
				$getJumlahRB = sqlArray(sqlQuery("select * from buku_induk_v3 where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and f='$f' and g='$g' and h='$h' and i='$i' and j ='$j'  and status_barang ='1' and kondisi='3'"));
		...
		echo 				"</table>";		
		$getDataKuasaPenggunaBarang = sqlArray(sqlQuery("select * from tandatangankuasapenggunabarang_v3 where c1= '$c1' and c='$c' and  d='$d' and e='$e' and e1 ='$e1'"));
...
function Pemeliharaan2($xls =FALSE){
		...
		$getKuasapenggunaBarang = sqlArray(sqlQuery("select * from ref_skpd where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1'"));
		$kuasaPenggunaBarang = $getKuasapenggunaBarang['nm_skpd'];
		$getLastTahap = sqlArray(sqlQuery("select max(id_anggaran) from view_rkbmd_v3 where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and j!='000' and (uraian_pemeliharaan !='' or uraian_pemeliharaan ='RKBMD PEMELIHARAAN') and jenis_form_modul ='KOREKSI PENGGUNA'  "));
		$lastIdAnggaran = $getLastTahap['max(id_anggaran)'];
		$getLastTahap = sqlArray(sqlQuery("select * from view_rkbmd_v3 where id_anggaran ='$lastIdAnggaran'"));
		$lastNomorUrut = $getLastTahap['no_urut'];	
		$getMinJenisForm = sqlArray(sqlQuery("select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and tahun='$this->tahun' and jenis_anggaran='$this->jenisAnggaran'"));
		...
		while($daqry = sqlArray($aqry)){
			...
			if($q == '0' && $j =='000'){
				...
				$getJumlahBarangSebelumnya = sqlArray(sqlQuery("select * from view_rkbmd_v3 where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and f='$f' and g='$g' and h='$h' and i='$i' and j ='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and uraian_pemeliharaan = '$uraian_pemeliharaan' and no_urut='$nomorurutSebelumnya' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' "));
				$jumlahBarangSebelumnya = number_format($getJumlahBarangSebelumnya['volume_barang'],0,'.',',');
				//$jumlahBarangSebelumnya = "select * from view_rkbmd_v3 where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and f='$f' and g='$g' and h='$h' and i='$i' and j ='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and uraian_pemeliharaan = '$uraian_pemeliharaan' and no_urut='$nomorurutSebelumnya' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'";
			}
			echo "
								<tr valign='top'>
									<td align='right' class='GarisCetak'>$no</td>
		...
		echo 				"</table>";		
		$getDataKuasaPenggunaBarang = sqlArray(sqlQuery("select * from tandatangankuasapenggunabarang_v3 where c1= '$c1' and c='$c' and  d='$d' and e='$e' and e1 ='$e1'"));
		$getDataPejabatPenggunaBarang = sqlArray(sqlQuery("select * from tandatanganpenggunabarang_v3 where c1= '$c1' and c='$c' and  d='$d' and kategori = 'PEJABAT'"));	
		$getDataPengurusPenggunaBarang = sqlArray(sqlQuery("select * from tandatanganpenggunabarang_v3 where c1= '$c1' and c='$c' and  d='$d' and kategori = 'PENGURUS'"));	
...
function Pemeliharaan4($xls =FALSE){
		...
		$getKuasapenggunaBarang = sqlArray(sqlQuery("select * from ref_skpd where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1'"));
		$kuasaPenggunaBarang = $getKuasapenggunaBarang['nm_skpd'];
		$getLastTahap = sqlArray(sqlQuery("select max(id_anggaran) from view_rkbmd_v3 where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1='$c1' and c='$c' and d='$d'  and j!='000' and (uraian_pemeliharaan !='' or uraian_pemeliharaan ='RKBMD PEMELIHARAAN') and jenis_form_modul ='KOREKSI PENGGUNA'  "));
		$lastIdAnggaran = $getLastTahap['max(id_anggaran)'];
		$getLastTahap = sqlArray(sqlQuery("select * from view_rkbmd_v3 where id_anggaran ='$lastIdAnggaran'"));
		$lastNomorUrut = $getLastTahap['no_urut'];	
		$getMinJenisForm = sqlArray(sqlQuery("select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and tahun='$this->tahun' and jenis_anggaran='$this->jenisAnggaran'"));
		...
		$qry ="select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and  uraian_pemeliharaan !='RKBMD PENGADAAN'   $Kondisi order by urut";
...
function Pemeliharaan5($xls =FALSE){
		...
		$getKuasapenggunaBarang = sqlArray(sqlQuery("select * from ref_skpd where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1'"));
		$kuasaPenggunaBarang = $getKuasapenggunaBarang['nm_skpd'];
		$getLastTahap = sqlArray(sqlQuery("select max(id_anggaran) from view_rkbmd_v3 where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1='$c1' and c='$c' and d='$d'  and j!='000' and (uraian_pemeliharaan !='' or uraian_pemeliharaan ='RKBMD PEMELIHARAAN') and jenis_form_modul ='KOREKSI PENGELOLA'  "));
		$lastIdAnggaran = $getLastTahap['max(id_anggaran)'];
		$getLastTahap = sqlArray(sqlQuery("select * from view_rkbmd_v3 where id_anggaran ='$lastIdAnggaran'"));
		$lastNomorUrut = $getLastTahap['no_urut'];	
		$getMinJenisForm = sqlArray(sqlQuery("select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and tahun='$this->tahun' and jenis_anggaran='$this->jenisAnggaran'"));
...
function Pemeliharaan7($xls =FALSE){
		...
		$getLastTahap = sqlArray(sqlQuery("select max(id_anggaran) from view_rkbmd_v3 where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'  and j!='000'  and uraian_pemeliharaan !='RKBMD PENGADAAN' and jenis_form_modul ='KOREKSI PENGELOLA'"));
		$lastIdAnggaran = $getLastTahap['max(id_anggaran)'];
		$getLastTahap = sqlArray(sqlQuery("select * from view_rkbmd_v3 where id_anggaran ='$lastIdAnggaran'"));
		$lastNomorUrut = $getLastTahap['no_urut'];	
		$arrKondisi = array();
		...
		$grabProgram = sqlQuery("select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan !='RKBMD PENGADAAN'  and p !='0' and q='0'");
		while($rows = sqlArray($grabProgram)){
			foreach ($rows as $key => $value) { 
				  $$key = $value; 
			}
			if(sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and uraian_pemeliharaan !=''  and bk='$bk' and ck='$ck' and p ='$p' and j!='000' ")) == 0){
				$concat = $bk.".".$ck.".".$p;
				$arrKondisi[] = " concat(bk,'.',ck,'.',p) !='$concat'";
			}else{
			$grabKegiatan = sqlQuery("select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan !='RKBMD PENGADAAN' and bk='$bk' and ck='$ck'  and p ='$p' and q!='0' and j='000'");
				while($row2s = sqlArray($grabKegiatan)){
					...
					if(sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan !=''  and bk='$bk' and ck='$ck' and p ='$p' and q='$q' and j!='000' ")) == 0){
						if($q != '0'){
							$concat = $bk.".".$ck.".".$p.".".$q;
							$arrKondisi[] = " concat(bk,'.',ck,'.',p,'.',q) !='$concat'";
						}
						...
						while($row3s = sqlArray($grabBarang)){
							...
							$concat = $f.".".$g.".".$h.".".$i.".".$j;
							if(sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and uraian_pemeliharaan !=''  and bk='$bk' and ck='$ck' and p ='$p' and q='$q' and concat(f,'.',g,'.',h,'.',i,'.',j) = '$concat' ")) == 0){
								if($j != '000'){
									$arrKondisi[] = " concat(f,'.',g,'.',h,'.',i,'.',j) !='$concat' ";
								}
							}
		...
		$qry ="select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and uraian_pemeliharaan !='RKBMD PENGADAAN'   $Kondisi order by urut";
		$aqry = sqlQuery($qry);
		...
		while($daqry = sqlArray($aqry)){
			...
			if($p == '0'){
				...
				if(sqlNumRow(sqlQuery("select * from view_rkbmd_v3 where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and uraian_pemeliharaan !=''  and c1='$c1' and c='$c' and d='$d' and j!='000' ")) == 0){
					$arrayExcept[] = $konket;
				}else{
