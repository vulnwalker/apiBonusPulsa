...
class tandaTanganPenggunaBarang_v3Obj  extends DaftarObj2{	
	...
	function setTitle(){
		return 'TANDA TANGAN  PENGGUNA BARANG';
	}
	...
	<A href=\"pages.php?Pg=tandaTanganKuasaPenggunaBarang_v3\" title='TANDA TANGAN PENGGUNA BARANG'  > TANDA TANGAN KUASA PENGGUNA BARANG </a> |
	<A href=\"pages.php?Pg=tandaTanganPenggunaBarang_v3\" title='TANDA TANGAN PENGGUNA BARANG'  style='color : blue;' > TANDA TANGAN PENGGUNA BARANG </a> |
	<A href=\"pages.php?Pg=tandaTanganPengelolaBarang_v3\" title='TANDA TANGAN PENGGUNA BARANG'   > TANDA TANGAN PENGELOLA BARANG </a> |
	&nbsp&nbsp&nbsp	
	</td></tr>
	</table>";
	}
	...
	//get data -----------------
	 ...
	 if( $err=='' && $nip =='' ) $err= 'NIP Belum Di Isi !!';
			...
			if($fmST == 0){
			$ck1=sqlArray(sqlQuery("Select * from $this->TblName where c1='$kode1' and c='$kode2' and d ='$kode3' and kategori = '$kategori'"));
	...
	//	$queryPangkat2=sqlArray(sqlQuery("select pangkat,concat(pangkat,' (',gol,'/',ruang,')')as nama from tandaTanganPenggunaBarang_v3 where pangkat='".$dt['pangkat']."' and gol='".$dt['gol']."' and ruang='".$dt['ruang']."'"));
	...
	$e1=$isi['e1'];
	 ...
	 $skpd=sqlArray(sqlQuery(" select nm_skpd from ref_skpd where c1='$c1' and c='$c' and d='$d'  "));
	 $Koloms = array();
