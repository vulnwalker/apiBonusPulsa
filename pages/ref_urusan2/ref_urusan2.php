...
class ref_urusan2Obj  extends DaftarObj2{	
	...
	function simpan(){
	 ...
	 $kondisi1=" concat(bk,ck,dk)='".$bk.$ck.$dk."' ";$cek.=$kondisi1;
			...
			$ck_urusan = sqlArray(sqlQuery("SELECT count(*) as cnt FROM ref_urusan2 WHERE $kondisi1 "));
	...
	case 'formBaru':{				
		...
		$get = sqlArray( sqlQuery("select * from ref_urusan2 where bk=$bk and ck=$ck and dk=$dk"));
