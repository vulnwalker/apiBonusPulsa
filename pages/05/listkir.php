...
$Qry = sqlQuery("select buku_induk.*,ref_barang.nm_barang,kir.p,kir.q,kir.ket as ketkir,kir.tgl_update as kir_tgl_update,kir.id as id_kir from buku_induk inner join ref_barang  using(f,g,h,i,j) inner join kir using(a,b,c,d,e,e1,f,g,h,j,i,j,noreg,tahun) where $Kondisi order by a,b,c,d,e,e1,f,g,h,i,j,noreg");
...
$Qry = sqlQuery("select buku_induk.*,ref_barang.nm_barang,kir.p,kir.q,kir.ket as ketkir,kir.tgl_update as kir_tgl_update,kir.id as id_kir from buku_induk inner join ref_barang using(f,g,h,i,j) inner join kir using(a,b,c,d,e,e1,f,g,h,i,j,noreg,tahun) where $Kondisi order by a,b,c,d,e,e1,f,g,h,i,j,noreg $LimitHalKIR");
